...
//	private static void doParse(final ClassDeclaration block) {
//		doParseClassDeclaration(block);
//	}
//
//	private static void doParseClassDeclaration(final ClassDeclaration block) {
...
//				VirtualSpecification.parseInto((ClassDeclaration) block);
//		}
//
//		if (Parser.accept(KeyWord.BEGIN))
//			   doParseBody(block, true);
...
//	private static void doParseProcedureDeclaration(final ProcedureDeclaration block) {
//		block.modifyIdentifier(expectIdentifier());
//		// Util.BREAK("BEGIN BlockParser: "+block);
//		// if(Option.TRACE_PARSE) Parser.BREAK("Begin BlockParser");
//		if (Parser.accept(KeyWord.BEGPAR)) {
...
//		if (Parser.accept(KeyWord.BEGIN))
//			 doParseBody(block, false);
//		else block.statements.add(Statement.doParse());
//	}

	private static void doParseBody(final BlockDeclaration block, final boolean inClass) {
		Statement stm;
		...
		if (inClass && inner != null)
			stmList.add(inner); // Implicit INNER
	}
