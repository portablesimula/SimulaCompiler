...
public class Main {
    ...
    public Main(PrintWriter out, String program) {
    	...
    	TestAsmTools.traceMYH("NEW org.openjdk.asmtools.jdis.Main: program="+program+", out="+out); // MYH
    }
    ...
    public static void main(String argv[]) {
    	TestAsmTools.traceMYH("org.openjdk.asmtools.jdis.Main.main: ",argv); // MYH
