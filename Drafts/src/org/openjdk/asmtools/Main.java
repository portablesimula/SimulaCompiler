...
public class Main {
    ...
    public static void main(String args[]) {
    	System.out.println("Main: main, args="+args); // MYH
    	System.out.println("Main: main, args.length="+args.length); // MYH
    	System.out.println("Main: main, args[0]="+args[0]); // MYH
    	System.out.println("Main: main, args[1]="+args[1]); // MYH
    	System.out.println("Main: main, args[2]="+args[2]); // MYH
    	System.out.println("Main: main, args[3]="+args[3]); // MYH
        //System.exit(0); // MYH
        if (args.length == 0) {
        ...
        if (cmd.equals("-?") || cmd.equals("-h") || cmd.equals("-help")) {
        	...
        	System.out.println("Main: main, cmd="+cmd+", newArgs="+newArgs); // MYH
            //System.exit(0); // MYH
            if (cmd.equals("jasm")) {
                jasm(newArgs);
    ...
    public static void jdec(String[] args) {
    	System.out.println("Main: jdec, args="+args); // MYH
    ...
    public static void jdis(String[] args) {
    	TestAsmTools.traceMYH("org.openjdk.asmtools.Main.jdis: ",args); // MYH
