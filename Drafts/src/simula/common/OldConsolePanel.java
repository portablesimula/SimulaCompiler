...
public final class OldConsolePanel extends JPanel {
	...
	public OutputStream getOutputStream() {
		return(new OutputStream() {
			...
			public void write(int b) throws IOException {
				String s=""+(char)b;
				OldConsolePanel.this.write(s,styleRegular);
			}});
	}
	...
	public OutputStream getErrorStream() {
		return(new OutputStream() {
			...
			public void write(int b) throws IOException {
				String s=""+(char)b;
				OldConsolePanel.this.write(s,styleError);
			}});
	}
