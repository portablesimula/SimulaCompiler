 ...
 */
public final class ForStatement_COPY extends Statement {
	...
	private class ForListElement {
		...
		public void doChecking() {
		    ...
		    expr1.doChecking(); 
			expr1.backLink=ForStatement_COPY.this; // To ensure RESULT$ from functions
		}
	...
	private class WhileElement extends ForListElement {
		...
		public void doChecking() {
			...
			expr1.backLink=ForStatement_COPY.this; // To ensure RESULT$ from functions
			expr2.backLink=ForStatement_COPY.this; // To ensure RESULT$ from functions
		}
		public String edCode(final String classIdent) {
			String forElt=(type==Type.Text && assignmentOperator.getKeyWord()==KeyWord.ASSIGNVALUE)?"TValElt":"Elt<"+classIdent+">";
	...
	private class StepUntilElement extends ForListElement {
		...
		public void doChecking() {
			...
			expr1.backLink=ForStatement_COPY.this; // To ensure RESULT$ from functions
			expr2.backLink=ForStatement_COPY.this; // To ensure RESULT$ from functions
			expr3.backLink=ForStatement_COPY.this; // To ensure RESULT$ from functions
		}
		public String edCode(final String classIdent) {
