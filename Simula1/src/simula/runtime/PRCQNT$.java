...
public final class PRCQNT$ {
	...
	public PROC$ CPF() {
		try {
			...
			throw new SimulaRuntimeError("PRCQNT$.CPF: FATAL error (1) - Impossible situation - " + e, e);
		} catch (Throwable e) {
			throw new SimulaRuntimeError("PRCQNT$.CPF: FATAL error (2) - Impossible situation - " + e, e);
		}
	}
