...
//	public static boolean USE_CONTINUATIONS=false;//true;
...
//		RTOption.USE_CONTINUATIONS=true;//false;//true;
...
//		if(RTOption.USE_CONTINUATIONS) args=args+" -USE_CONTINUATIONS";
...
//		if(id.equalsIgnoreCase("USE_CONTINUATIONS")) return(USE_CONTINUATIONS); 
...
//		if(id.equalsIgnoreCase("USE_CONTINUATIONS")) USE_CONTINUATIONS=val; 
