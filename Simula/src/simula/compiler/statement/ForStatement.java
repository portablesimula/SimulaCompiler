 ...
 * "https://github.com/portablesimula/SimulaCompiler/blob/master/Simula/src/simula/compiler/statement/ForStatement.java"><b>Source File</b></a>.
 * 
...
public final class ForStatement extends Statement {
	...
	private class ForListElement {
		...
		public String edCode(final String classIdent, Type xType) {
			String forElt = (type == Type.Text && assignmentOperator.getKeyWord() == KeyWord.ASSIGNVALUE) ? "TValElt"
					: "Elt<" + classIdent + ">";
