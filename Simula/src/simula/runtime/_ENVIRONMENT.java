 ...
 * drawing, etc.
 * <p>
 * Link to GitHub: <a href="https://github.com/portablesimula/SimulaCompiler/blob/master/Simula/src/simula/runtime/_ENVIRONMENT.java"><b>Source File</b></a>.
 * 
...
public class _ENVIRONMENT extends _RTObject {
	...
	public static _TXT simulaid() {
		...
		String job = _RT.progamIdent;
		String acc = user;
		String prog = _RT.progamIdent;
	...
	/**
	 * Standard Procedure addepsilon.
	 * See {@link _ENVIRONMENT#addepsilon(float)}
	...
	/**
	 * Standard Procedure subepsilon.
	 * See {@link _ENVIRONMENT#subepsilon(float)}
	 * @param x double argument
	 * @return the argument decremented by the smallest possible value
	 */
	...
	/**
	 * Standard Procedure char.
	 * See {@link _ENVIRONMENT#Char(int)}
	 * 
	 * @param i an integer agrgument
	 * @return the casted value: (char) i
	 */
	...
	/**
	 * Standard Procedure max.
	 * See {@link _ENVIRONMENT#max(double,double)}
	 * @param x the parameter x
	 * @param y the parameter y
	 * @return the greater of the two parameter values
	 */
	...
	/**
	 * Standard Procedure min.
	 * See {@link _ENVIRONMENT#min(double,double)}
	 * @param x the parameter x
	 * @param y the parameter y
	 * @return the lesser of the two parameter values
	 */
	 ...
	 */
	public static int histd(final _REALTYPE_ARRAY A, final _NAME<Integer> U) {
		int result = 0;
		int j; // Array index.
	 ...
	 */
	public static void histo(final _REAL_ARRAY A, final _REAL_ARRAY B, final float c, final float d) {
		if (A.nDim() != 1)
	 ...
	 * <p>
	 * See {@link _ENVIRONMENT#DEFEXCEPTION(_PRCQNT)}
	 */
	 ...
	 */
	public static char loadChar(final _TXT t, final int p) {
	 ...
	 * @param p the text position in which the character is stored 
	 */
	public static void storeChar(final char c, final _TXT t, final int p) {
