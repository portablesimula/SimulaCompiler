...
public final class RTConsolePanel extends JPanel {
		...
		if (consoleReader == null) {
			consoleReader = new Reader() {
				public int read(final char[] cbuf,final int off,final int len) throws IOException {
					...
					//while(reading) Thread.yield();
					while(RTConsolePanel.this.read() != '\n');
	...
	public OutputStream getOutputStream() {
		return(new OutputStream() {
			...
			public void write(int b) throws IOException {
				String s=""+(char)b;
				RTConsolePanel.this.write(s,styleRegular);
			}});
	}
	...
	public Writer getWriter() {
		return(new Writer() {
			public void write(String s) {
				RTConsolePanel.this.write(s);		
			}
			public void write(char[] cbuf, int off, int len) throws IOException {
				RTConsolePanel.this.write(new String(cbuf,off,len));
			}
	...
	public OutputStream getErrorStream() {
		return(new OutputStream() {
			...
			public void write(int b) throws IOException {
				String s=""+(char)b;
				RTConsolePanel.this.write(s,styleError);
			}});
	}
