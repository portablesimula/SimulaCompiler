            ...
            public void STM$() {
                ...
                LOOP$:while(JTX$>=0) {
                    try {
                        ...
                        LABEL$(1,"REUSE");
                        LABEL$(2,"S0");
                        if(VALUE$((caller.stmtreq==(((PARSER$grammer)(CUR$.SL$)).allbutif)))) {
                        ...
                        // JavaLine 64 ==> SourceLine 1252
                        {
                            ...
                            if(VALUE$((((PARSER$grammer)(CUR$.SL$)).cs==(((PARSER)(CUR$.SL$.SL$)).ITHEN)))) {
                    ...
                    if(VALUE$((((PARSER$grammer)(CUR$.SL$)).cs==(((PARSER)(CUR$.SL$.SL$)).IELSE)))) {
