        ...
        LOOP$:while(JTX$>=0) {
            try {
                ...
                // JavaLine 57 ==> SourceLine 499
                {
                    ...
                    if(VALUE$(((((BUILDER2$normalattrfile)(CUR$.SL$)).p+(tlength))>(((BUILDER2$normalattrfile)(CUR$.SL$)).bufmax)))) {
                        // JavaLine 61 ==> SourceLine 500
                        {
                            TRACE_BEGIN_STM$("CompoundStatement500",500);
                            if(VALUE$((tlength>(((BUILDER2$normalattrfile)(CUR$.SL$)).bufmax)))) {
                    ...
                    if(VALUE$((tlength>=(rank(((BUILDER2$normalattrfile)(CUR$.SL$)).lowKey))))) {
