            ...
            public void STM$() {
                ...
                LOOP$:while(JTX$>=0) {
                    try {
                        ...
                        if(VALUE$(((((PARSER$grammer)(CUR$.SL$)).blockfound==(0))&&((((PARSER)(CUR$.SL$.SL$)).dummygen|((!(((PARSER)(CUR$.SL$.SL$)).separatecomp)))))))) {
                        ...
                        if(VALUE$((((PARSER$grammer)(CUR$.SL$)).cs==(((PARSER)(CUR$.SL$.SL$)).IWHEN)))) {
                            firstwhen=true;
                        } else
                    ...
                    while((((PARSER$grammer)(CUR$.SL$)).cs==(((PARSER)(CUR$.SL$.SL$)).IWHEN))) {
                        // JavaLine 133 ==> SourceLine 1746
                        {
                            ...
                            if(VALUE$((((PARSER)(CUR$.SL$.SL$)).opt!=(((PARSER)(CUR$.SL$.SL$)).IDO)))) {
