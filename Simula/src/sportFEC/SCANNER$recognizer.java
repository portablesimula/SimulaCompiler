                ...
                LOOP$:while(JTX$>=0) {
                    try {
                        ...
                        // JavaLine 154 ==> SourceLine 1097
                        {
                            ...
                            // JavaLine 159 ==> SourceLine 1098
                            {
                                ...
                                if(VALUE$((((SCANNER)(CUR$.SL$)).optx==(((SCANNER)(CUR$.SL$)).NUL)))) {
                                    {
                        ...
                        // JavaLine 263 ==> SourceLine 1137
                        {
                            ...
                            if(VALUE$((InputClass.Elt[rank(atom)-InputClass.LB[0]]==(((SCANNER)(CUR$.SL$)).Digit_cl)))) {
                        ...
                        // JavaLine 293 ==> SourceLine 1149
                        {
                            ...
                            if(VALUE$(((((InputClass.Elt[rank(atom)-InputClass.LB[0]]==(((SCANNER)(CUR$.SL$)).Digit_cl))||((atom==('&'))))||((atom==('-'))))||((atom==('+')))))) {
                        ...
                        // JavaLine 342 ==> SourceLine 1170
                        {
                            ...
                            if(VALUE$((atom==('-')))) {
                                // JavaLine 350 ==> SourceLine 1174
                                {
                                    ...
                                    if(VALUE$((!(((SCANNER)(CUR$.SL$)).SportOK)))) {
                        ...
                        // JavaLine 478 ==> SourceLine 1224
                        {
                            ...
                            if(VALUE$((atom!=('"')))) {
                                // JavaLine 497 ==> SourceLine 1230
                                {
                                    ...
                                    if(VALUE$(((atom!=(((SCANNER)(CUR$.SL$)).EOL))||((linepos<(linelength)))))) {
                            ...
                            if(VALUE$((atom==('"')))) {
                                // JavaLine 562 ==> SourceLine 1253
                                {
                                    ...
                                    if(VALUE$(((TXT$.length(hashbuf)-(textpos))<(80)))) {
                            ...
                            // JavaLine 586 ==> SourceLine 1261
                            {
                                ...
                                if(VALUE$((TXT$.length(hashbuf)>(80)))) {
                                    hashbuf=blanks(80);
                                }
                        ...
                        // JavaLine 606 ==> SourceLine 1270
                        {
                            ...
                            if(VALUE$((atom==(((SCANNER)(CUR$.SL$)).EOL)))) {
                        ...
                        // JavaLine 780 ==> SourceLine 1331
                        {
                            ...
                            if(VALUE$((((SCANNER)(CUR$.SL$)).option.Elt[rank('X')-((SCANNER)(CUR$.SL$)).option.LB[0]]!=(((SCANNER)(CUR$.SL$)).NUL)))) {
                        ...
                        if(VALUE$(((curidhi!=(((SCANNER)(CUR$.SL$)).NUL))||((curidlo>(((SCANNER)(CUR$.SL$)).IFALS)))))) {
                        ...
                        // JavaLine 1299 ==> SourceLine 1455
                        {
                            ...
                            if(VALUE$(((SCANNER)(CUR$.SL$)).Simuletta)) {
                                GOTO$(ParserC); // GOTO EVALUATED LABEL
                            }
                        ...
                        // JavaLine 1357 ==> SourceLine 1485
                        {
                            ...
                            while((((SCANNER)(CUR$.SL$)).opt==(((SCANNER)(CUR$.SL$)).IEND))) {
                                // JavaLine 1361 ==> SourceLine 1486
                                {
                                    ...
                                    if(VALUE$((((SCANNER)(CUR$.SL$)).maxnumoftags==(0)))) {
                                        // JavaLine 1483 ==> SourceLine 1539
                                        {
                                            TRACE_BEGIN_STM$("CompoundStatement1539",1539);
                                            if(VALUE$((((SCANNER)(CUR$.SL$)).opt==(((SCANNER)(CUR$.SL$)).ISMCL)))) {
                                                new SCANNER$recognizer$ScanPastFormat(((SCANNER$recognizer)CUR$));
                                            }
                                            // JavaLine 1489 ==> SourceLine 1541
                                            if(VALUE$((atom!=(((char)26))))) {
                    ...
                    if(VALUE$((InputClass.Elt[rank(atom)-InputClass.LB[0]]<(((SCANNER)(CUR$.SL$)).Digit_cl)))) {
                        // JavaLine 1520 ==> SourceLine 1552
                        {
                            ...
                            if(VALUE$(((((SCANNER)(CUR$.SL$)).hashlo==(nxtsym))&&((((SCANNER)(CUR$.SL$)).hashhi==(((SCANNER)(CUR$.SL$)).NUL)))))) {
                    ...
                    if(VALUE$(((curidlo!=(((SCANNER)(CUR$.SL$)).NUL))||((curidhi!=(((SCANNER)(CUR$.SL$)).NUL)))))) {
