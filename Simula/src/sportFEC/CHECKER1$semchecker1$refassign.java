                ...
                LOOP$:while(JTX$>=0) {
                    try {
                        ...
                        while(true) {
                            // JavaLine 42 ==> SourceLine 995
                            {
                                ...
                                if(VALUE$((type==(p1$source.type)))) {
                                    // JavaLine 56 ==> SourceLine 1000
                                    {
                                        ...
                                        if(VALUE$((((CHECKER1$semchecker1)(CUR$.SL$)).valassList==(null)))) {
                                ...
                                if(VALUE$(((p1$source.type==(((CHECKER1)(CUR$.SL$.SL$)).IREF))||((p1$source.type==(((CHECKER1)(CUR$.SL$.SL$)).ITEXT)))))) {
                                ...
                                if(VALUE$((type==(p1$source.type)))) {
                                    // JavaLine 90 ==> SourceLine 1011
                                    {
                                        ...
                                        // JavaLine 96 ==> SourceLine 1013
                                        {
                                            ...
                                            if(VALUE$((p1$source.qual==(null)))) {
                                            } else
                                            // JavaLine 103 ==> SourceLine 1015
                                            if(VALUE$(new BUILDER1$precheck0$subclass(((CHECKER1$semchecker1)(CUR$.SL$)),p1$source.qual,qual).RESULT$)) {
                                            } else
                                            // JavaLine 106 ==> SourceLine 1016
                                            if(VALUE$(new BUILDER1$precheck0$subclass(((CHECKER1$semchecker1)(CUR$.SL$)),qual,p1$source.qual).RESULT$)) {
                                                // JavaLine 108 ==> SourceLine 1018
                                                {
                                                    TRACE_BEGIN_STM$("CompoundStatement1018",1018);
                                                    if(VALUE$(IS$(p1$source,CHECKER1$semchecker1$newIdent.class))) {
                            ...
                            if(VALUE$((p1$source.ctype==(((CHECKER1)(CUR$.SL$.SL$)).IIDN)))) {
                                {
                                    TRACE_BEGIN_STM$("CompoundStatement1029",1029);
                                    if(VALUE$((p1$source.kind!=(((CHECKER1)(CUR$.SL$.SL$)).K_ident)))) {
                            ...
                            if(VALUE$((p1$target.ctype==(((CHECKER1)(CUR$.SL$.SL$)).IIDN)))) {
                                // JavaLine 150 ==> SourceLine 1034
                                {
                                    ...
                                    // JavaLine 156 ==> SourceLine 1036
                                    {
                                        ...
                                        if(VALUE$((p1$target.meaning.protect==(((char)2))))) {
                                            // JavaLine 162 ==> SourceLine 1038
                                            {
                                                TRACE_BEGIN_STM$("CompoundStatement1038",1038);
                                                if(VALUE$((((CHECKER1$semchecker1)(CUR$.SL$)).readonly==(p1$target.meaning)))) {
                                    ...
                                    if(VALUE$(new CHECKER1$semchecker1$identifier$result(((CHECKER1$semchecker1$identifier)(p1$target))).RESULT$)) {
                                        // JavaLine 192 ==> SourceLine 1052
                                        {
                                            TRACE_BEGIN_STM$("CompoundStatement1052",1052);
                                            issimple=1;
                                            // JavaLine 196 ==> SourceLine 1053
                                            if(VALUE$((p1$target.type==(((CHECKER1)(CUR$.SL$.SL$)).INOTY)))) {
                        ...
                        if(VALUE$((p1$target.ctype==(((CHECKER1)(CUR$.SL$.SL$)).IIDNP)))) {
                            // JavaLine 214 ==> SourceLine 1062
                            {
                                TRACE_BEGIN_STM$("CompoundStatement1062",1062);
                                {
                                    ...
                                    // JavaLine 221 ==> SourceLine 1063
                                    {
                                        ...
                                        if(VALUE$((inspect$1062$10.p1$ident.meaning.protect==(((char)2))))) {
                                            // JavaLine 232 ==> SourceLine 1067
                                            {
                                                TRACE_BEGIN_STM$("CompoundStatement1067",1067);
                                                if(VALUE$((((CHECKER1$semchecker1)(CUR$.SL$)).readonly==(inspect$1062$10.p1$ident.meaning)))) {
                                                    ((CHECKER1$semchecker1)(CUR$.SL$)).readonly=null;
                                                } else
