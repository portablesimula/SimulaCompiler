...
public final class PARSER$grammer$markStmt extends BASICIO$ {
    ...
    public PARSER$grammer$markStmt STM$() {
        ...
        if(VALUE$((((((PARSER$grammer)(CUR$.SL$)).last.blockstatus==(((PARSER$grammer)(CUR$.SL$)).stmtnotseen))||((((PARSER$grammer)(CUR$.SL$)).stmtwnt==(((PARSER$grammer)(CUR$.SL$)).classbody))))||((((PARSER$grammer)(CUR$.SL$)).stmtwnt==(((PARSER$grammer)(CUR$.SL$)).procbody)))))) {
