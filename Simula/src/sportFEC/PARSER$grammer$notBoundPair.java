    ...
    public PARSER$grammer$notBoundPair STM$() {
        ...
        LOOP$:while(JTX$>=0) {
            try {
                ...
                if(((((PARSER$grammer)(CUR$.SL$)).cs!=(((PARSER)(CUR$.SL$.SL$)).ICL))&&((((PARSER$grammer)(CUR$.SL$)).cs!=(((PARSER)(CUR$.SL$.SL$)).IDENO))))) {
                ...
                if((p$colon==(((PARSER)(CUR$.SL$.SL$)).IPSPC))) {
                    {
                ...
                if((((PARSER$grammer)(CUR$.SL$)).cs==(((PARSER)(CUR$.SL$.SL$)).IDENO))) {
