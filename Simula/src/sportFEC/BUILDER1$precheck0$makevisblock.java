    ...
    public BUILDER1$precheck0$makevisblock STM$() {
        ...
        LOOP$:while(JTX$>=0) {
            try {
                ...
                if(VALUE$((q.kind==(((BUILDER1)(CUR$.SL$.SL$)).K_class)))) {
                    lowpl=((BUILDER1)(CUR$.SL$.SL$)).zero;
                } else
                // JavaLine 70 ==> SourceLine 317
                if(VALUE$((q.kind==(((BUILDER1)(CUR$.SL$.SL$)).K_prefbl)))) {
                    lowpl=((BUILDER1)(CUR$.SL$.SL$)).zero;
                } else
                        ...
                        if(VALUE$((qz.visible==(((BUILDER1)(CUR$.SL$.SL$)).NUL)))) {
                            {
                                ...
                                // JavaLine 90 ==> SourceLine 323
                                {
                                    ...
                                    if(VALUE$((inspect$321$6.curmeaning==(null)))) {
                                    ...
                                    // JavaLine 101 ==> SourceLine 327
                                    {
                                        ...
                                        if(VALUE$(((((COMMON$quantity)(inspect$321$6.curmeaning)).encl.blev!=(qblev))||((inspect$321$6.curmeaning==(qz)))))) {
