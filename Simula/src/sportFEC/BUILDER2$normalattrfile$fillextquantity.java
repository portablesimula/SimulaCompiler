...
public final class BUILDER2$normalattrfile$fillextquantity extends BASICIO$ {
    ...
    public BUILDER2$normalattrfile$fillextquantity STM$() {
        ...
        if(VALUE$((((BUILDER2$normalattrfile)(CUR$.SL$)).xcateg==(((BUILDER2)(CUR$.SL$.SL$)).C_extnal)))) {
            // JavaLine 76 ==> SourceLine 175
            {
                ...
                if(VALUE$(IS$(p$xq.descr,COMMON$extbrecord.class))) {
        ...
        if(VALUE$(((p$xq.special!=(((BUILDER2)(CUR$.SL$.SL$)).NUL))||((p$xq.kind==(((BUILDER2)(CUR$.SL$.SL$)).K_rep)))))) {
            // JavaLine 119 ==> SourceLine 199
            {
                ...
                if(VALUE$((p$xq.kind==(((BUILDER2)(CUR$.SL$.SL$)).K_rep)))) {
