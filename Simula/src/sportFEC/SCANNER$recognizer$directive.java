    ...
    public SCANNER$recognizer$directive STM$() {
        ...
        LOOP$:while(JTX$>=0) {
            try {
                ...
                if(VALUE$(((((SCANNER$recognizer)(CUR$.SL$)).atom==(((char)32)))||((((SCANNER$recognizer)(CUR$.SL$)).atom==(((SCANNER)(CUR$.SL$.SL$)).EOL)))))) {
                    GOTO$(SKIPLINE); // GOTO EVALUATED LABEL
                }
                // JavaLine 61 ==> SourceLine 719
                if(VALUE$((((SCANNER$recognizer)(CUR$.SL$)).atom==('+')))) {
                    // JavaLine 63 ==> SourceLine 721
                    {
                        ...
                        if(VALUE$((((SCANNER$recognizer)(CUR$.SL$)).atom==(((char)32))))) {
                            ...
                            // JavaLine 93 ==> SourceLine 728
                            {
                                ...
                                if(VALUE$((((SCANNER$recognizer)(CUR$.SL$)).atom==(((char)32))))) {
                                    // JavaLine 103 ==> SourceLine 731
                                    {
                                        ...
                                        LABEL$(2,"SELECTED");
                                        if(VALUE$((((SCANNER$recognizer)(CUR$.SL$)).linepos>=(((SCANNER$recognizer)(CUR$.SL$)).linelength)))) {
                                            GOTO$(SKIPLINE); // GOTO EVALUATED LABEL
                                        }
                ...
                if(VALUE$(TXTREL$EQ(u,new TXT$("title")))) {
                ...
                if(VALUE$(TXTREL$EQ(u,new TXT$("page")))) {
                    // JavaLine 144 ==> SourceLine 749
                    {
                        ...
                        if(VALUE$(((SCANNER)(CUR$.SL$.SL$)).listingon)) {
                            {
                                // BEGIN INSPECTION 
                ...
                if(VALUE$((TXTREL$EQ(u,new TXT$("copy"))|(TXTREL$EQ(u,new TXT$("insert")))))) {
                ...
                if(VALUE$(TXTREL$EQ(u,new TXT$("definition")))) {
                ...
                if(VALUE$(TXTREL$EQ(u,new TXT$("implementation")))) {
                ...
                if(VALUE$(TXTREL$EQ(u,new TXT$("list")))) {
                    // JavaLine 224 ==> SourceLine 770
                    {
                        TRACE_BEGIN_STM$("CompoundStatement770",770);
                        if(VALUE$(new SCANNER$recognizer$directive$onoff(((SCANNER$recognizer$directive)CUR$)).RESULT$)) {
                ...
                if(VALUE$(TXTREL$EQ(u,new TXT$("nodummy")))) {
                ...
                if(VALUE$(TXTREL$EQ(u,new TXT$("slength")))) {
                ...
                if(VALUE$(TXTREL$EQ(u,new TXT$("select")))) {
                ...
                if(VALUE$(TXTREL$EQ(u,new TXT$("record")))) {
                ...
                // JavaLine 283 ==> SourceLine 812
                {
                    ...
                    if(VALUE$((((((TXTREL$EQ(u,new TXT$("boundcheck"))|(TXTREL$EQ(u,new TXT$("nonecheck"))))|(TXTREL$EQ(u,new TXT$("implnone"))))|(TXTREL$EQ(u,new TXT$("quacheck"))))|(TXTREL$EQ(u,new TXT$("reuse"))))|(TXTREL$EQ(u,new TXT$("sport")))))) {
                        // JavaLine 287 ==> SourceLine 816
                        {
                            ...
                            if(VALUE$(TXTREL$EQ(u,new TXT$("sport")))) {
                    ...
                    if(VALUE$(TXTREL$EQ(u,new TXT$("setswitch")))) {
                ...
                if(VALUE$(false)) {
                    // JavaLine 335 ==> SourceLine 838
                    {
                        ...
                        LABEL$(5,"DIRWARN");
                        if(VALUE$(((SCANNER)(CUR$.SL$.SL$)).GiveNotes)) {
