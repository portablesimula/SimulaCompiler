...
public final class CHECKER1$semchecker1$valassign$emit extends BASICIO$ {
    ...
    COMMON$quantity inspect$797$7=null;
    // Normal Constructor
    ...
    public CHECKER1$semchecker1$valassign$emit STM$() {
        ...
        if(VALUE$((((CHECKER1$semchecker1$valassign)(CUR$.SL$)).type==(((CHECKER1)(CUR$.SL$.SL$.SL$)).ITEXT)))) {
            // JavaLine 27 ==> SourceLine 748
            {
                ...
                if(VALUE$((((CHECKER1$semchecker1$valassign)(CUR$.SL$)).cl==(((CHECKER1$semchecker1)(CUR$.SL$.SL$)).IEEXPcl)))) {
        ...
        // JavaLine 52 ==> SourceLine 766
        {
            ...
            if(VALUE$((((((CHECKER1$semchecker1$valassign)(CUR$.SL$)).p1$source.ctype==(((CHECKER1)(CUR$.SL$.SL$.SL$)).IUPLS))&&((((CHECKER1$semchecker1$operation)(((CHECKER1$semchecker1$valassign)(CUR$.SL$)).p1$source)).p1$left!=(null))))&&(((boolean)(((CHECKER1$semchecker1$valassign)(CUR$.SL$)).p1$target.sameAs$0().CPF().setPar(((CHECKER1$semchecker1$operation)(((CHECKER1$semchecker1$valassign)(CUR$.SL$)).p1$source)).p1$left).ENT$().RESULT$())))))) {
                // JavaLine 57 ==> SourceLine 771
                {
                    ...
                    if(VALUE$((((CHECKER1$semchecker1$valassign)(CUR$.SL$)).p1$source.type!=(((CHECKER1$semchecker1$operation)(((CHECKER1$semchecker1$valassign)(CUR$.SL$)).p1$source)).p1$left.type)))) {
            ...
            // JavaLine 76 ==> SourceLine 780
            {
                ...
                if(VALUE$((((CHECKER1$semchecker1$valassign)(CUR$.SL$)).issimple==(0)))) {
            ...
            if(VALUE$((((CHECKER1$semchecker1$valassign)(CUR$.SL$)).type!=(((CHECKER1$semchecker1$valassign)(CUR$.SL$)).p1$source.type)))) {
            ...
            if(VALUE$((((CHECKER1$semchecker1$valassign)(CUR$.SL$)).p1$target.ctype==(((CHECKER1)(CUR$.SL$.SL$.SL$)).IIDN)))) {
                // JavaLine 103 ==> SourceLine 794
                {
                    TRACE_BEGIN_STM$("CompoundStatement794",794);
                    if(VALUE$(((((CHECKER1$semchecker1$valassign)(CUR$.SL$)).issimple!=(0))&&(IS$(((CHECKER1$semchecker1$valassign)(CUR$.SL$)).p1$target,CHECKER1$semchecker1$dotIdent.class))))) {
                    ...
                    {
                        // BEGIN INSPECTION 
                        inspect$797$7=((CHECKER1$semchecker1$valassign)(CUR$.SL$)).p1$target.meaning;
                        if(inspect$797$7!=null) //INSPECT inspect$797$7
                        // JavaLine 120 ==> SourceLine 798
                        {
                            TRACE_BEGIN_STM$("CompoundStatement798",798);
                            ((CHECKER1)(CUR$.SL$.SL$.SL$)).coder.opq=((COMMON$quantity)inspect$797$7);
                            // JavaLine 124 ==> SourceLine 799
                            if(VALUE$((inspect$797$7.categ==(((CHECKER1)(CUR$.SL$.SL$.SL$)).C_virt)))) {
                                ((CHECKER1)(CUR$.SL$.SL$.SL$)).coder.opq=inspect$797$7.match;
                            }
                            ...
                            if(VALUE$((((CHECKER1$semchecker1$valassign)(CUR$.SL$)).issimple!=(0)))) {
                                // JavaLine 130 ==> SourceLine 801
                                {
                                    ...
                                    if(VALUE$((inspect$797$7.kind==(((CHECKER1)(CUR$.SL$.SL$.SL$)).K_proc)))) {
                            ...
                            if(VALUE$((inspect$797$7.categ==(((CHECKER1)(CUR$.SL$.SL$.SL$)).C_name)))) {
