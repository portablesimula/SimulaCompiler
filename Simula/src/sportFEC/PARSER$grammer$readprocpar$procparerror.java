    ...
    public PARSER$grammer$readprocpar$procparerror STM$() {
        ...
        LOOP$:while(JTX$>=0) {
            try {
                ...
                if(VALUE$((((PARSER$grammer)(CUR$.SL$.SL$)).cs==(((PARSER)(CUR$.SL$.SL$.SL$)).ISMCL)))) {
                ...
                if(VALUE$(((((PARSER$grammer)(CUR$.SL$.SL$)).cs==(((PARSER)(CUR$.SL$.SL$.SL$)).INAME))||((((PARSER$grammer)(CUR$.SL$.SL$)).cs==(((PARSER)(CUR$.SL$.SL$.SL$)).IVALU)))))) {
                    GOTO$(((PARSER$grammer$readprocpar)(CUR$.SL$)).namevaluepart); // GOTO EVALUATED LABEL
                }
