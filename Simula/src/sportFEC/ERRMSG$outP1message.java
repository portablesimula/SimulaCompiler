    ...
    public ERRMSG$outP1message STM$() {
        ...
        LOOP$:while(JTX$>=0) {
            try {
                ...
                if(VALUE$(((((ERRMSG)(CUR$.SL$)).lasterrline==(((ERRMSG)(CUR$.SL$)).linenr))&&(((((ERRMSG)(CUR$.SL$)).lasterrpos>=(p$where))|((((ERRMSG)(CUR$.SL$)).lasterrmess==(p$message)))))))) {
                    // JavaLine 62 ==> SourceLine 175
                    {
                        ...
                        if(VALUE$((((ERRMSG)(CUR$.SL$)).errloop>(4)))) {
                ...
                if(VALUE$((((ERRMSG)(CUR$.SL$)).lasterrline!=(((ERRMSG)(CUR$.SL$)).linenr)))) {
                ...
                if(VALUE$(((((ERRMSG)(CUR$.SL$)).lasterrpos!=(p$where))|((((ERRMSG)(CUR$.SL$)).lasterrline!=(((ERRMSG)(CUR$.SL$)).linenr)))))) {
