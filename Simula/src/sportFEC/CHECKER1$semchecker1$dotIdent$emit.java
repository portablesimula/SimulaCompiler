...
public final class CHECKER1$semchecker1$dotIdent$emit extends BASICIO$ {
    ...
    public CHECKER1$semchecker1$dotIdent$emit STM$() {
        ...
        if((((CHECKER1$semchecker1$dotIdent)(CUR$.SL$)).cl==(((CHECKER1$semchecker1)(CUR$.SL$.SL$)).IEEXPcl))) {
            // JavaLine 79 ==> SourceLine 1585
            {
                TRACE_BEGIN_STM$("CompoundStatement1585",1585);
                {
                    ...
                    // JavaLine 86 ==> SourceLine 1587
                    {
                        ...
                        // JavaLine 93 ==> SourceLine 1593
                        {
                            ...
                            if((((CHECKER1$semchecker1)(CUR$.SL$.SL$)).opc!=(((CHECKER1)(CUR$.SL$.SL$.SL$)).IQUA))) {
                                {
                                    TRACE_BEGIN_STM$("CompoundStatement1593",1593);
                ...
                if((((CHECKER1$semchecker1$dotIdent)(CUR$.SL$)).p$ch==(((CHECKER1)(CUR$.SL$.SL$.SL$)).IDOT))) {
                    // JavaLine 123 ==> SourceLine 1601
                    {
                        ...
                        // JavaLine 128 ==> SourceLine 1603
                        {
                            ...
                            if((((CHECKER1$semchecker1$dotIdent)(CUR$.SL$)).meaning.descr==(null))) {
...
// JavaLine 169 ==> SourceLine 1628
{
    ...
    if(((((CHECKER1$semchecker1$dotIdent)(CUR$.SL$)).cl==(((CHECKER1$semchecker1)(CUR$.SL$.SL$)).ITEXTcl))||((((CHECKER1$semchecker1$dotIdent)(CUR$.SL$)).cl==(((CHECKER1$semchecker1)(CUR$.SL$.SL$)).ITOcl))))) {
    ...
    if((((CHECKER1$semchecker1$dotIdent)(CUR$.SL$)).cl==(((CHECKER1$semchecker1)(CUR$.SL$.SL$)).IACTEcl))) {
