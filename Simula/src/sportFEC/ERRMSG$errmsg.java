    ...
    public ERRMSG$errmsg STM$() {
        ...
        LOOP$:while(JTX$>=0) {
            try {
                ...
                if(VALUE$(((ERRMSG)(CUR$.SL$)).ERRnotopen)) {
                ...
                if(VALUE$(((p$i>(0))&&((p$i<=(((ERRMSG)(CUR$.SL$)).uplim)))))) {
                    // JavaLine 69 ==> SourceLine 130
                    {
                        TRACE_BEGIN_STM$("CompoundStatement130",130);
                        if(VALUE$((((ERRMSG)(CUR$.SL$)).ERRORFILE==(null)))) {
                        ...
                        if(VALUE$((!(((ERRMSG)(CUR$.SL$)).ERRnotopen)))) {
                            // JavaLine 90 ==> SourceLine 140
                            {
                                ...
                                if(VALUE$((!(((ERRMSG)(CUR$.SL$)).ERRORFILE.open(t))))) {
                                ...
                                if(VALUE$(((ERRMSG)(CUR$.SL$)).ERRORFILE.endfile())) {
