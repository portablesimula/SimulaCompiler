...
public final class CHECKER1$semchecker1$identifier$result extends BASICIO$ {
    ...
    public CHECKER1$semchecker1$identifier$result STM$() {
        ...
        if((((CHECKER1$semchecker1$identifier)(CUR$.SL$)).p$ch==(((CHECKER1)(CUR$.SL$.SL$.SL$)).IIDN))) {
            {
                ...
                if((((CHECKER1$semchecker1$identifier)(CUR$.SL$)).meaning!=(null))) {
                    // JavaLine 37 ==> SourceLine 1337
                    {
                        ...
                        if(((procblev>(5))&((procblev<=(rank(((CHECKER1)(CUR$.SL$.SL$.SL$)).cblev)))))) {
                            // JavaLine 43 ==> SourceLine 1342
                            {
                                ...
                                if((blquant.kind==(((CHECKER1)(CUR$.SL$.SL$.SL$)).K_proc))) {
                                    blquant=blquant.prefqual;
                                }
