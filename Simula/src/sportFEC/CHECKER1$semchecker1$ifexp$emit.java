...
public final class CHECKER1$semchecker1$ifexp$emit extends BASICIO$ {
    ...
    public CHECKER1$semchecker1$ifexp$emit STM$() {
        ...
        if(VALUE$((((CHECKER1$semchecker1$ifexp)(CUR$.SL$)).p2$testexp.ctype!=(((CHECKER1)(CUR$.SL$.SL$.SL$)).IEQ)))) {
        ...
        if(VALUE$((((CHECKER1$semchecker1$ifexp)(CUR$.SL$)).type!=(((CHECKER1$semchecker1$ifexp)(CUR$.SL$)).p1$left.type)))) {
        ...
        if(VALUE$((((CHECKER1$semchecker1$ifexp)(CUR$.SL$)).type!=(((CHECKER1$semchecker1$ifexp)(CUR$.SL$)).p1$right.type)))) {
