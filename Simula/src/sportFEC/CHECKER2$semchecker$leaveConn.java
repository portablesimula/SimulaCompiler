...
public final class CHECKER2$semchecker$leaveConn extends BASICIO$ {
    ...
    COMMON$brecord inspect$212$7=null;
    // JavaLine 20 ==> SourceLine 216
    COMMON$brecord inspect$216$8=null;
    // JavaLine 22 ==> SourceLine 221
    COMMON$stackedb inspect$221$9=null;
    // JavaLine 24 ==> SourceLine 238
    COMMON$brecord inspect$238$10=null;
    // Normal Constructor
    ...
    public CHECKER2$semchecker$leaveConn STM$() {
        ...
        {
            // BEGIN INSPECTION 
            inspect$212$7=((CHECKER2)(CUR$.SL$.SL$)).display.Elt[rank(((CHECKER2)(CUR$.SL$.SL$)).cblev)-((CHECKER2)(CUR$.SL$.SL$)).display.LB[0]];
            if(inspect$212$7!=null) //INSPECT inspect$212$7
            // JavaLine 43 ==> SourceLine 213
            {
                TRACE_BEGIN_STM$("CompoundStatement213",213);
                q=inspect$212$7.fpar;
                new BUILDER1$precheck0$invischain(((CHECKER2$semchecker)(CUR$.SL$)),q);
                // JavaLine 48 ==> SourceLine 214
                if(VALUE$((inspect$212$7.declquant.prefqual!=(null)))) {
                    // JavaLine 50 ==> SourceLine 216
                    {
                        TRACE_BEGIN_STM$("CompoundStatement216",216);
                        {
                            // BEGIN INSPECTION 
                            inspect$216$8=inspect$212$7.declquant.prefqual.descr;
                            if(inspect$216$8!=null) //INSPECT inspect$216$8
                            // JavaLine 57 ==> SourceLine 217
                            {
                                TRACE_BEGIN_STM$("CompoundStatement217",217);
                                if(VALUE$((inspect$216$8.kind==(((CHECKER2)(CUR$.SL$.SL$)).K_subbl)))) {
                                ...
                                // JavaLine 68 ==> SourceLine 221
                                {
                                    ...
                                    {
                                        // BEGIN INSPECTION 
                                        inspect$221$9=inspect$216$8.preinsp;
                                        if(inspect$221$9!=null) //INSPECT inspect$221$9
                                        // JavaLine 75 ==> SourceLine 222
                                        {
                                            TRACE_BEGIN_STM$("CompoundStatement222",222);
                                            chain=inspect$221$9.redeclChain;
                                    ...
                                    ((CHECKER2)(CUR$.SL$.SL$)).prefixchain.Elt[1-((CHECKER2)(CUR$.SL$.SL$)).prefixchain.LB[0]]=q=inspect$216$8.declquant;
                                    opimax=((CHECKER2)(CUR$.SL$.SL$)).one;
                                    // JavaLine 97 ==> SourceLine 230
                                    while((opimax<(inspect$216$8.declquant.plev))) {
                                    ...
                                    while((q!=(null))) {
                                        // JavaLine 112 ==> SourceLine 238
                                        {
                                            ...
                                            {
                                                // BEGIN INSPECTION 
                                                inspect$238$10=q.descr;
                                                if(inspect$238$10!=null) //INSPECT inspect$238$10
                                                if(VALUE$((inspect$238$10.preinsp!=(null)))) {
                                                    // JavaLine 120 ==> SourceLine 239
                                                    {
                                                        TRACE_BEGIN_STM$("CompoundStatement239",239);
                                                        inspect$238$10.blev=inspect$238$10.preinsp.p$oldblev;
                                                        // JavaLine 124 ==> SourceLine 240
                                                        inspect$238$10.rtblev=inspect$238$10.preinsp.p$oldrtblev;
                                                        // JavaLine 126 ==> SourceLine 241
                                                        inspect$238$10.connests=inspect$238$10.preinsp.p$oldconnests;
                                                        // JavaLine 128 ==> SourceLine 242
                                                        inspect$238$10.inspected=inspect$238$10.preinsp.p$oldinsp;
                                                        // JavaLine 130 ==> SourceLine 243
                                                        inspect$238$10.preinsp=inspect$238$10.preinsp.p$prev;
