            ...
            public void STM$() {
                ...
                LOOP$:while(JTX$>=0) {
                    try {
                        ...
                        if(VALUE$((type!=(((CHECKER1)(CUR$.SL$.SL$)).IREF)))) {
                            // JavaLine 40 ==> SourceLine 589
                            {
                                TRACE_BEGIN_STM$("CompoundStatement589",589);
                                if(VALUE$(((type!=(((CHECKER1)(CUR$.SL$.SL$)).IELSE))&((type!=(((CHECKER1)(CUR$.SL$.SL$)).IPTR)))))) {
                        ...
                        if(VALUE$((p1$right.qual!=(null)))) {
                            // JavaLine 54 ==> SourceLine 593
                            {
                                ...
                                if(VALUE$((qual.kind==(((CHECKER1)(CUR$.SL$.SL$)).K_class)))) {
                                    // JavaLine 58 ==> SourceLine 594
                                    {
                                        TRACE_BEGIN_STM$("CompoundStatement594",594);
                                        if(VALUE$((p1$right.qual==(qual)))) {
                                        ...
                                        if(VALUE$(new BUILDER1$precheck0$subclass(((CHECKER1$semchecker1)(CUR$.SL$)),p1$right.qual,qual).RESULT$)) {
                                        } else
                                        // JavaLine 74 ==> SourceLine 598
                                        if(VALUE$(new BUILDER1$precheck0$subclass(((CHECKER1$semchecker1)(CUR$.SL$)),qual,p1$right.qual).RESULT$)) {
                                            // JavaLine 76 ==> SourceLine 599
                                            {
                                                TRACE_BEGIN_STM$("CompoundStatement599",599);
                                                if(VALUE$((((CHECKER1)(CUR$.SL$.SL$)).NoneCheck||(((CHECKER1)(CUR$.SL$.SL$)).QuaCheck)))) {
                                                    L3opq=qual;
                                                }
                                ...
                                if(VALUE$((qual.kind==(((CHECKER1)(CUR$.SL$.SL$)).K_record)))) {
                                    // JavaLine 93 ==> SourceLine 604
                                    {
                                        TRACE_BEGIN_STM$("CompoundStatement604",604);
                                        if(VALUE$((p1$right.qual.kind==(((CHECKER1)(CUR$.SL$.SL$)).K_record)))) {
