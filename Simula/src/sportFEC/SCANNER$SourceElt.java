            ...
            public void STM$() {
                ...
                LOOP$:while(JTX$>=0) {
                    try {
                        ...
                        if(VALUE$(TXTREL$NE(lowcase(copy(copy(p1$fname))),new TXT$("sysin")))) {
                            // JavaLine 65 ==> SourceLine 451
                            {
                                ...
                                while((inpt!=(null))) {
                                    // JavaLine 71 ==> SourceLine 453
                                    {
                                        ...
                                        if(VALUE$((IS$(inpt,SCANNER$SourceElt.class)&&(TXTREL$EQ(((SCANNER$SourceElt)(inpt)).p1$fname,p1$fname))))) {
                            ...
                            // JavaLine 107 ==> SourceLine 464
                            {
                                ...
                                if(VALUE$(sf.inrecord())) {
                                    // JavaLine 115 ==> SourceLine 467
                                    {
                                        ...
                                        if(VALUE$((TXT$.length(((SCANNER)(CUR$.SL$)).line)>(256)))) {
                                ...
                                if(VALUE$((linlen>(((SCANNER)(CUR$.SL$)).signiflength)))) {
