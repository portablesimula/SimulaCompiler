...
public class CHECKER2$semchecker extends CHECKER1$semchecker1 {
    ...
    // JavaLine 12 ==> SourceLine 889
    final LABQNT$ NEXTOPN=new LABQNT$(this,3,1); // Local Label #1=NEXTOPN
    // JavaLine 14 ==> SourceLine 926
    final LABQNT$ gennap=new LABQNT$(this,3,2); // Local Label #2=gennap
    // JavaLine 16 ==> SourceLine 958
    final LABQNT$ STACK=new LABQNT$(this,3,3); // Local Label #3=STACK
    // JavaLine 18 ==> SourceLine 960
    final LABQNT$ REPLACE=new LABQNT$(this,3,4); // Local Label #4=REPLACE
    // JavaLine 20 ==> SourceLine 986
    final LABQNT$ OPNOUT=new LABQNT$(this,3,5); // Local Label #5=OPNOUT
    // JavaLine 22 ==> SourceLine 1028
    final LABQNT$ outbb=new LABQNT$(this,3,6); // Local Label #6=outbb
    // JavaLine 24 ==> SourceLine 1097
    final LABQNT$ Acon=new LABQNT$(this,3,7); // Local Label #7=Acon
    // JavaLine 26 ==> SourceLine 1106
    final LABQNT$ SetCon=new LABQNT$(this,3,8); // Local Label #8=SetCon
    // JavaLine 28 ==> SourceLine 1107
    final LABQNT$ SetCo1=new LABQNT$(this,3,9); // Local Label #9=SetCo1
    // JavaLine 30 ==> SourceLine 1108
    final LABQNT$ SetCo2=new LABQNT$(this,3,10); // Local Label #10=SetCo2
    // JavaLine 32 ==> SourceLine 1150
    final LABQNT$ swap=new LABQNT$(this,3,11); // Local Label #11=swap
    // JavaLine 34 ==> SourceLine 1175
    final LABQNT$ POPEXPEXP=new LABQNT$(this,3,12); // Local Label #12=POPEXPEXP
    // JavaLine 36 ==> SourceLine 1211
    final LABQNT$ repu=new LABQNT$(this,3,13); // Local Label #13=repu
    // JavaLine 38 ==> SourceLine 1304
    final LABQNT$ Eass=new LABQNT$(this,3,14); // Local Label #14=Eass
    // JavaLine 40 ==> SourceLine 1324
    final LABQNT$ LIARGE=new LABQNT$(this,3,15); // Local Label #15=LIARGE
    // JavaLine 42 ==> SourceLine 1367
    final LABQNT$ KERR1=new LABQNT$(this,3,16); // Local Label #16=KERR1
    // JavaLine 44 ==> SourceLine 1387
    final LABQNT$ KERR2=new LABQNT$(this,3,17); // Local Label #17=KERR2
    // JavaLine 46 ==> SourceLine 1421
    final LABQNT$ LIWHEN1=new LABQNT$(this,3,18); // Local Label #18=LIWHEN1
    // JavaLine 48 ==> SourceLine 1434
    final LABQNT$ bscp=new LABQNT$(this,3,19); // Local Label #19=bscp
    // JavaLine 50 ==> SourceLine 1463
    final LABQNT$ opqout=new LABQNT$(this,3,20); // Local Label #20=opqout
    // JavaLine 52 ==> SourceLine 1499
    final LABQNT$ LIFORE=new LABQNT$(this,3,21); // Local Label #21=LIFORE
    // JavaLine 54 ==> SourceLine 1571
    final LABQNT$ bnde1=new LABQNT$(this,3,22); // Local Label #22=bnde1
                    ...
                    try {
                        ...
                        // JavaLine 126 ==> SourceLine 872
                        {
                            ...
                            while(true) {
                                // JavaLine 130 ==> SourceLine 874
                                {
                                    ...
                                    // JavaLine 162 ==> SourceLine 909
                                    {
                                        ...
                                        if(VALUE$((((CHECKER2)(CUR$.SL$)).opn==(((CHECKER2)(CUR$.SL$)).IDOT)))) {
                                            GOTO$(NEXTOPN); // GOTO EVALUATED LABEL
                                        }
                                    ...
                                    // JavaLine 276 ==> SourceLine 966
                                    {
                                        ...
                                        if(VALUE$((((CHECKER2)(CUR$.SL$)).option.Elt[rank('L')-((CHECKER2)(CUR$.SL$)).option.LB[0]]!=(((CHECKER2)(CUR$.SL$)).NUL)))) {
                                        ...
                                        if(VALUE$((opi>(((CHECKER2)(CUR$.SL$)).linenr)))) {
                                    ...
                                    // JavaLine 361 ==> SourceLine 1014
                                    {
                                        ...
                                        if(VALUE$((((CHECKER2)(CUR$.SL$)).opn==(((CHECKER2)(CUR$.SL$)).IBLKB)))) {
                                            // JavaLine 367 ==> SourceLine 1017
                                            {
                                                ...
                                                // JavaLine 372 ==> SourceLine 1019
                                                {
                                                    ...
                                                    if(VALUE$((inspect$1017$16.kind==(((CHECKER2)(CUR$.SL$)).K_proc)))) {
                                                        // JavaLine 376 ==> SourceLine 1020
                                                        {
                                                            ...
                                                            // JavaLine 381 ==> SourceLine 1021
                                                            {
                                                                ...
                                                                if(VALUE$((inspect$1020$17.descr!=(null)))) {
                                    ...
                                    // JavaLine 429 ==> SourceLine 1046
                                    {
                                        ...
                                        // JavaLine 437 ==> SourceLine 1049
                                        {
                                            ...
                                            if(VALUE$((inspect$1049$18.categ==(((CHECKER2)(CUR$.SL$)).C_virt)))) {
                                                {
                                                    TRACE_BEGIN_STM$("CompoundStatement1050",1050);
                                                    if(VALUE$((inspect$1049$18.match!=(null)))) {
                                    ...
                                    // JavaLine 620 ==> SourceLine 1154
                                    {
                                        ...
                                        if(VALUE$((exptop.ctype==(((CHECKER2)(CUR$.SL$)).IIDN)))) {
                                        ...
                                        if(VALUE$((exptop.type==(((CHECKER2)(CUR$.SL$)).ICHAR)))) {
                                        ...
                                        if(VALUE$((exptop.type!=(((CHECKER2)(CUR$.SL$)).IINTG)))) {
                                            {
                                                TRACE_BEGIN_STM$("CompoundStatement1158",1158);
                                                if(VALUE$((exptop.type!=(((CHECKER2)(CUR$.SL$)).ISHOR)))) {
                                    ...
                                    // JavaLine 696 ==> SourceLine 1187
                                    {
                                        ...
                                        if(VALUE$((opc!=(((CHECKER2)(CUR$.SL$)).IGOE)))) {
                                    ...
                                    // JavaLine 735 ==> SourceLine 1211
                                    {
                                        ...
                                        if(VALUE$((unstop==(((CHECKER2)(CUR$.SL$)).INOTY)))) {
                                            GOTO$(NEXTOPN); // GOTO EVALUATED LABEL
                                        }
                                        // JavaLine 745 ==> SourceLine 1213
                                        if(VALUE$(((((unstop==(((CHECKER2)(CUR$.SL$)).IFRMP))|((unstop==(((CHECKER2)(CUR$.SL$)).IGOTO))))|((unstop==(((CHECKER2)(CUR$.SL$)).IDCLS))))|((unstop==(((CHECKER2)(CUR$.SL$)).IIFSB)))))) {
                                    ...
                                    // JavaLine 784 ==> SourceLine 1251
                                    {
                                        ...
                                        if(VALUE$((exptop.type!=(((CHECKER2)(CUR$.SL$)).IBOOL)))) {
                                            {
                                                TRACE_BEGIN_STM$("CompoundStatement1252",1252);
                                                if(VALUE$((exptop.type!=(((CHECKER2)(CUR$.SL$)).IELSE)))) {
                                        ...
                                        if(VALUE$((exptop.ctype==(((CHECKER2)(CUR$.SL$)).IEQ)))) {
                                            exptop.cl=IIFSBcl;
                                        }
                                    ...
                                    // JavaLine 823 ==> SourceLine 1265
                                    {
                                        ...
                                        if(VALUE$((exptop.type!=(((CHECKER2)(CUR$.SL$)).ILABE)))) {
                                            {
                                    ...
                                    // JavaLine 862 ==> SourceLine 1284
                                    {
                                        ...
                                        if(VALUE$((((CHECKER1$semchecker1$valassign)(exptop)).p1$source.type>(((CHECKER2)(CUR$.SL$)).IINTG)))) {
                                            // JavaLine 870 ==> SourceLine 1288
                                            {
                                                TRACE_BEGIN_STM$("CompoundStatement1288",1288);
                                                {
                                                    ...
                                                    if(VALUE$((((COMMON$quantity)(inspect$1288$19.curmeaning)).symb==(((COMMON$identsymbol)inspect$1288$19))))) {
                                    ...
                                    // JavaLine 932 ==> SourceLine 1324
                                    {
                                        ...
                                        if(VALUE$((((CHECKER2)(CUR$.SL$)).opn==(((CHECKER2)(CUR$.SL$)).IBEGI)))) {
                                            {
                                    ...
                                    if(VALUE$((exptop.ctype==(((CHECKER2)(CUR$.SL$)).IIDNP)))) {
                                            ...
                                            TRACE_BEGIN_STM$("CompoundStatement1374",1374);
                                            {
                                                ...
                                                // JavaLine 1021 ==> SourceLine 1375
                                                {
                                                    ...
                                                    // JavaLine 1028 ==> SourceLine 1378
                                                    {
                                                        ...
                                                        if(VALUE$((inspect$1374$20.p$ch==(((CHECKER2)(CUR$.SL$)).IIDNP)))) {
                            ...
                            // JavaLine 1066 ==> SourceLine 1399
                            {
                                ...
                                if(VALUE$((exptop.type!=(((CHECKER2)(CUR$.SL$)).IREF)))) {
                                ...
                                if(VALUE$(IS$(exptop,CHECKER1$semchecker1$newIdent.class))) {
                                    implNone=false;
                                } else
                                // JavaLine 1096 ==> SourceLine 1411
                                if(VALUE$(IS$(exptop,CHECKER1$semchecker1$argumented.class))) {
                                    // JavaLine 1098 ==> SourceLine 1412
                                    {
                                        TRACE_BEGIN_STM$("CompoundStatement1412",1412);
                                        if(VALUE$(IS$(((CHECKER1$semchecker1$argumented)(exptop)).p1$ident,CHECKER1$semchecker1$newIdent.class))) {
                                ...
                                if(VALUE$((((CHECKER2)(CUR$.SL$)).opn==(((CHECKER2)(CUR$.SL$)).ICONB)))) {
                                    {
                            ...
                            // JavaLine 1122 ==> SourceLine 1419
                            {
                                ...
                                if(VALUE$((cquant==(null)))) {
                                    cquant=new ERRMSG$newnotseen(((CHECKER2)(CUR$.SL$)),opdSymb).RESULT$;
                                }
                                // JavaLine 1137 ==> SourceLine 1424
                                if(VALUE$(((cquant.kind!=(((CHECKER2)(CUR$.SL$)).K_class))&&((cquant.categ!=(((CHECKER2)(CUR$.SL$)).C_unknwn)))))) {
                                ...
                                // JavaLine 1147 ==> SourceLine 1426
                                {
                                    ...
                                    if(VALUE$((exptop.qual!=(null)))) {
                                        // JavaLine 1151 ==> SourceLine 1427
                                        {
                                            TRACE_BEGIN_STM$("CompoundStatement1427",1427);
                                            if(VALUE$((!((new BUILDER1$precheck0$subclass(((CHECKER2$semchecker)CUR$),exptop.qual,cquant).RESULT$||(new BUILDER1$precheck0$subclass(((CHECKER2$semchecker)CUR$),cquant,exptop.qual).RESULT$)))))) {
                            ...
                            // JavaLine 1190 ==> SourceLine 1448
                            {
                                ...
                                // JavaLine 1200 ==> SourceLine 1452
                                {
                                    ...
                                    // JavaLine 1205 ==> SourceLine 1453
                                    {
                                        ...
                                        if(VALUE$((inspect$1452$21.categ==(((CHECKER2)(CUR$.SL$)).C_name)))) {
                                            new ERRMSG$error0(((CHECKER2)(CUR$.SL$)),-180);
                                        }
                                        // JavaLine 1211 ==> SourceLine 1454
                                        if(VALUE$((inspect$1452$21.kind!=(((CHECKER2)(CUR$.SL$)).K_ident)))) {
                                            // JavaLine 1213 ==> SourceLine 1455
                                            {
                                                TRACE_BEGIN_STM$("CompoundStatement1455",1455);
                                                if(VALUE$((inspect$1452$21.kind!=(((CHECKER2)(CUR$.SL$)).K_error)))) {
                            ...
                            // JavaLine 1240 ==> SourceLine 1468
                            {
                                ...
                                // JavaLine 1244 ==> SourceLine 1470
                                {
                                    ...
                                    if(VALUE$(((inspect$1470$22.kind==(((CHECKER2)(CUR$.SL$)).K_class))||((inspect$1470$22.kind==(((CHECKER2)(CUR$.SL$)).K_prefbl)))))) {
                            ...
                            // JavaLine 1329 ==> SourceLine 1508
                            {
                                ...
                                opttop=(opttop+(1));
                                if(VALUE$((opttop>(((CHECKER2)(CUR$.SL$)).maxdepth)))) {
                                ...
                                if(VALUE$(checkclb)) {
                                    {
                                        ...
                                        if(VALUE$(IS$(exptop,CHECKER1$semchecker1$arithconst.class))) {
                                            // JavaLine 1428 ==> SourceLine 1552
                                            {
                                                TRACE_BEGIN_STM$("CompoundStatement1552",1552);
                                                if(VALUE$(inarraybound)) {
                            ...
                            if(VALUE$((((CHECKER2)(CUR$.SL$)).opn==(((CHECKER2)(CUR$.SL$)).IARDE)))) {
                                {
