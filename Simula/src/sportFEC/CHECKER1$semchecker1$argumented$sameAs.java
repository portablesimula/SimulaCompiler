    ...
    public CHECKER1$semchecker1$argumented$sameAs STM$() {
        ...
        LOOP$:while(JTX$>=0) {
            try {
                ...
                if(VALUE$((p$e.ctype==(((CHECKER1)(CUR$.SL$.SL$.SL$)).IIDNP)))) {
                    // JavaLine 56 ==> SourceLine 1793
                    {
                        TRACE_BEGIN_STM$("CompoundStatement1793",1793);
                        if(VALUE$((p$e.meaning==(((CHECKER1$semchecker1$argumented)(CUR$.SL$)).p1$ident.meaning)))) {
                            // JavaLine 60 ==> SourceLine 1794
                            {
                                TRACE_BEGIN_STM$("CompoundStatement1794",1794);
                                if(VALUE$(((boolean)(((CHECKER1$semchecker1$argumented)(CUR$.SL$)).p1$ident.sameAs$0().CPF().setPar(((CHECKER1$semchecker1$argumented)(p$e)).p1$ident).ENT$().RESULT$())))) {
                                    // JavaLine 64 ==> SourceLine 1796
                                    {
                                        ...
                                        while((arg1!=(null))) {
                                            // JavaLine 71 ==> SourceLine 1798
                                            {
                                                ...
                                                if(VALUE$((!(((boolean)(arg1.p$actual.sameAs$0().CPF().setPar(arg2.p$actual).ENT$().RESULT$())))))) {
