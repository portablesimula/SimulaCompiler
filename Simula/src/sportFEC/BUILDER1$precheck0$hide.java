...
public final class BUILDER1$precheck0$hide extends BASICIO$ {
    ...
    // JavaLine 13 ==> SourceLine 531
    final LABQNT$ REP=new LABQNT$(this,0,1); // Local Label #1=REP
    // JavaLine 15 ==> SourceLine 532
    final LABQNT$ SCAN=new LABQNT$(this,0,2); // Local Label #2=SCAN
    // JavaLine 17 ==> SourceLine 550
    final LABQNT$ SETM=new LABQNT$(this,0,3); // Local Label #3=SETM
    // JavaLine 19 ==> SourceLine 563
    final LABQNT$ NEXTATTR=new LABQNT$(this,0,4); // Local Label #4=NEXTATTR
                    ...
                    // JavaLine 85 ==> SourceLine 522
                    {
                        ...
                        while((qz!=(null))) {
                            // JavaLine 121 ==> SourceLine 533
                            {
                                ...
                                if(VALUE$((qz.visible==(((BUILDER1)(CUR$.SL$.SL$)).NUL)))) {
                                            ...
                                            // JavaLine 131 ==> SourceLine 536
                                            {
                                                ...
                                                if(VALUE$((cvis.line>=(0)))) {
                                                    // JavaLine 135 ==> SourceLine 538
                                                    {
                                                        ...
                                                        if(VALUE$((new COMMON$boxof(((BUILDER1)(CUR$.SL$.SL$)),cvis.idhi,cvis.idlo).RESULT$==(qz.symb)))) {
                                                            // JavaLine 139 ==> SourceLine 540
                                                            {
                                                                TRACE_BEGIN_STM$("CompoundStatement540",540);
                                                                if(VALUE$((p$attrHide&(((qz.categ==(((BUILDER1)(CUR$.SL$.SL$)).C_local))|((qz.categ==(((BUILDER1)(CUR$.SL$.SL$)).C_virt)))))))) {
                                                                ...
                                                                if(VALUE$(inlocals)) {
                                                                    // JavaLine 150 ==> SourceLine 547
                                                                    {
                                                                        ...
                                                                        if(VALUE$(((qz.match==(null))||((qz.match.categ==(((BUILDER1)(CUR$.SL$.SL$)).C_virt)))))) {
                        ...
                        if(VALUE$((p$q.plev>(((BUILDER1)(CUR$.SL$.SL$)).one)))) {
    ...
    public static PROGINFO$ INFO$=new PROGINFO$("BUILDER1.DEF","Procedure hide",1,504,13,531,15,532,17,550,19,563,21,572,23,576,26,510,30,511,33,512,70,516,73,517,75,518,83,521,85,522,90,523,92,524,94,525,96,526,100,527,103,528,105,529,113,531,117,564,119,532,121,533,125,534,129,535,131,536,135,538,139,540,143,543,146,544,148,545,150,547,154,550,159,551,161,552,171,556,175,557,183,560,191,563,197,565,199,566,208,568,210,569,218,572,221,573,223,574,229,575,234,576,255,578);
}
