            ...
            public void STM$() {
                ...
                LOOP$:while(JTX$>=0) {
                    try {
                        ...
                        if(VALUE$((p$ch==(((CHECKER1)(CUR$.SL$.SL$)).IBPRF)))) {
                            // JavaLine 54 ==> SourceLine 1823
                            {
                                TRACE_BEGIN_STM$("CompoundStatement1823",1823);
                                if(VALUE$((p1$ident.kind!=(((CHECKER1)(CUR$.SL$.SL$)).K_class)))) {
                                    {
                                        TRACE_BEGIN_STM$("CompoundStatement1823",1823);
                                        if(VALUE$((p1$ident.kind!=(((CHECKER1)(CUR$.SL$.SL$)).K_error)))) {
                        ...
                        if(VALUE$(IS$(meaning,COMMON$extquantity.class))) {
                            // JavaLine 80 ==> SourceLine 1834
                            {
                                ...
                                // JavaLine 85 ==> SourceLine 1844
                                {
                                    ...
                                    if(VALUE$((inspect$1834$15.longindic!=(((CHECKER1)(CUR$.SL$.SL$)).NUL)))) {
                                        // JavaLine 89 ==> SourceLine 1845
                                        {
                                            ...
                                            if(VALUE$((searched==(((CHECKER1)(CUR$.SL$.SL$)).ISHOR)))) {
                                            ...
                                            if(VALUE$((i>(10)))) {
                                                // JavaLine 113 ==> SourceLine 1850
                                                {
                                                    ...
                                                    if(VALUE$((p.nextarg.p$actual.type>(searched)))) {
                                                    ...
                                                    while((i>=(0))) {
                                                        // JavaLine 133 ==> SourceLine 1856
                                                        {
                                                            ...
                                                            if(VALUE$((((COMMON$quantity)(q.descr.fpar.next)).type>=(searched)))) {
                                                ...
                                                // JavaLine 151 ==> SourceLine 1862
                                                {
                                                    ...
                                                    while((i>=(0))) {
                                                        // JavaLine 155 ==> SourceLine 1863
                                                        {
                                                            ...
                                                            if(VALUE$((q.descr.fpar.type>=(searched)))) {
                                                            ...
                                                            if(VALUE$((q.clf==(((CHECKER1)(CUR$.SL$.SL$)).Clf005)))) {
                                                                q=((COMMON$extquantity)(q.next));
                                                            }
                                            ...
                                            while((p!=(null))) {
                                                // JavaLine 204 ==> SourceLine 1884
                                                {
                                                    ...
                                                    if(VALUE$((ftype!=(p.p$actual.type)))) {
                                                        ...
                                                        if(VALUE$((ftype<(((CHECKER1)(CUR$.SL$.SL$)).INOTY)))) {
                                                            new CHECKER1$semchecker1$argument$errARG(p,426);
                                                        }
                                                    } // END SWITCH STATEMENT
                            ...
                            if(VALUE$(IS$(p1$arguments,CHECKER1$semchecker1$parameter.class))) {
                                // JavaLine 249 ==> SourceLine 1930
                                {
                                    TRACE_BEGIN_STM$("CompoundStatement1930",1930);
                                    if(VALUE$(((inspect$1834$15.clf==(((CHECKER1)(CUR$.SL$.SL$)).Clf010))|((inspect$1834$15.clf==(((CHECKER1)(CUR$.SL$.SL$)).Clf007)))))) {
                                                ...
                                                // JavaLine 259 ==> SourceLine 1933
                                                {
                                                    TRACE_BEGIN_STM$("CompoundStatement1933",1933);
                                                    {
                                                        ...
                                                        // JavaLine 266 ==> SourceLine 1934
                                                        {
                                                            ...
                                                            if(VALUE$((inspect$1933$16.categ==(((CHECKER1)(CUR$.SL$.SL$)).C_name)))) {
                                                                // JavaLine 270 ==> SourceLine 1935
                                                                {
                                                                    TRACE_BEGIN_STM$("CompoundStatement1935",1935);
                                                                    if(VALUE$((p.p$actual.ctype!=(((CHECKER1)(CUR$.SL$.SL$)).IIDN)))) {
                                                                        new CHECKER1$semchecker1$argument$errARG(p,433);
                                                                    }
                                                                    // JavaLine 276 ==> SourceLine 1936
                                                                    if(VALUE$((p.p$actual.type!=(inspect$1933$16.type)))) {
                ...
                if(VALUE$((p1$noofexpargs!=(p1$noofactargs)))) {
