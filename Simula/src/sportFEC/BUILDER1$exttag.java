...
public final class BUILDER1$exttag extends BASICIO$ {
    ...
    public BUILDER1$exttag STM$() {
        ...
        if(VALUE$(((p$q.visible==(((BUILDER1)(CUR$.SL$)).NUL))||((p$q.protect==(((char)1))))))) {
            // JavaLine 46 ==> SourceLine 634
            {
                ...
                if(VALUE$((p$q.categ==(((BUILDER1)(CUR$.SL$)).C_virt)))) {
                    RESULT$=-1;
                } else
                // JavaLine 54 ==> SourceLine 637
                if(VALUE$((p$q.categ==(((BUILDER1)(CUR$.SL$)).C_extnal)))) {
                    // JavaLine 56 ==> SourceLine 638
                    {
                        TRACE_BEGIN_STM$("CompoundStatement638",638);
                        if(VALUE$(IS$(p$q.descr,COMMON$extbrecord.class))) {
                            RESULT$=-1;
                        } else
                ...
                if(VALUE$((IS$(p$q,COMMON$extquantity.class)&&((((COMMON$extquantity)(p$q)).clf==(((BUILDER1)(CUR$.SL$)).Clf002)))))) {
                    // JavaLine 69 ==> SourceLine 644
                    RESULT$=-1;
                } else
                // JavaLine 72 ==> SourceLine 645
                if(VALUE$(((p$q.special>(((char)1)))&&((p$q.type!=(((BUILDER1)(CUR$.SL$)).ITEXT)))))) {
                    // JavaLine 74 ==> SourceLine 649
                    RESULT$=-1;
                } else
                // JavaLine 77 ==> SourceLine 650
                if(VALUE$(((p$q.kind==(((BUILDER1)(CUR$.SL$)).K_class))&&((p$q.categ==(((BUILDER1)(CUR$.SL$)).C_local)))))) {
                ...
                if(VALUE$(((p$q.kind==(((BUILDER1)(CUR$.SL$)).K_proc))&&((p$q.categ==(((BUILDER1)(CUR$.SL$)).C_local)))))) {
                    // JavaLine 84 ==> SourceLine 654
                    ((BUILDER1)(CUR$.SL$)).nextexttag=(((BUILDER1)(CUR$.SL$)).nextexttag+(2));
                } else
                // JavaLine 87 ==> SourceLine 656
                if(VALUE$((p$q.encl.declquant.categ==(((BUILDER1)(CUR$.SL$)).C_virt)))) {
