            ...
            public void STM$() {
                ...
                LOOP$:while(JTX$>=0) {
                    try {
                        ...
                        if(VALUE$((p1$right.kind!=(((CHECKER1)(CUR$.SL$.SL$)).K_ident)))) {
                            {
                        ...
                        if(VALUE$((p1$left.ctype==(((CHECKER1)(CUR$.SL$.SL$)).IIDN)))) {
                            // JavaLine 42 ==> SourceLine 449
                            {
                                ...
                                if(VALUE$((p1$left.kind!=(((CHECKER1)(CUR$.SL$.SL$)).K_ident)))) {
                        ...
                        if(VALUE$((p1$left.p$ch==(((CHECKER1)(CUR$.SL$.SL$)).ICONS)))) {
                            // JavaLine 53 ==> SourceLine 452
                            {
                                TRACE_BEGIN_STM$("CompoundStatement452",452);
                                if(VALUE$(((p$ch==(((CHECKER1)(CUR$.SL$.SL$)).IPLUS))||((p$ch==(((CHECKER1)(CUR$.SL$.SL$)).IMULT)))))) {
