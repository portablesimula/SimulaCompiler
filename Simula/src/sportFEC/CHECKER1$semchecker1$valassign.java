    ...
    public CHECKER1$semchecker1$valassign(RTObject$ staticLink,CHECKER1$semchecker1$exp sp$pred,char sp$ch,CHECKER1$semchecker1$exp sp1$target,CHECKER1$semchecker1$exp sp1$source) {
        ...
        CODE$=new ClassBody(CODE$,this,1) {
            public void STM$() {
                    ...
                    try {
                        ...
                        while(true) {
                            // JavaLine 40 ==> SourceLine 815
                            {
                                ...
                                if(VALUE$((p1$source.type==(((CHECKER1)(CUR$.SL$.SL$)).IREF)))) {
                                    // JavaLine 49 ==> SourceLine 821
                                    {
                                        ...
                                        if(VALUE$((((CHECKER1$semchecker1)(CUR$.SL$)).refassList==(null)))) {
                        ...
                        if(VALUE$((p1$target.ctype==(((CHECKER1)(CUR$.SL$.SL$)).IIDN)))) {
                            // JavaLine 104 ==> SourceLine 845
                            {
                                ...
                                // JavaLine 150 ==> SourceLine 864
                                {
                                    ...
                                    if(VALUE$((p1$target.type==(((CHECKER1)(CUR$.SL$.SL$)).ITEXT)))) {
                        ...
                        // JavaLine 189 ==> SourceLine 879
                        {
                            TRACE_BEGIN_STM$("CompoundStatement879",879);
                            {
                                ...
                                // JavaLine 196 ==> SourceLine 880
                                {
                                    ...
                                    if(VALUE$((inspect$879$8.p1$ident.meaning.protect==(((char)2))))) {
                                        // JavaLine 209 ==> SourceLine 885
                                        {
                                            TRACE_BEGIN_STM$("CompoundStatement885",885);
                                            if(VALUE$((((CHECKER1$semchecker1)(CUR$.SL$)).readonly==(inspect$879$8.p1$ident.meaning)))) {
                                                ((CHECKER1$semchecker1)(CUR$.SL$)).readonly=null;
                                            } else
                                    ...
                                    if(VALUE$((inspect$879$8.type==(((CHECKER1)(CUR$.SL$.SL$)).ITEXT)))) {
                ...
                if(VALUE$((p1$target.p$ch==(((CHECKER1)(CUR$.SL$.SL$)).IRGPA)))) {
                ...
                if(VALUE$((p1$target.p$ch==(((CHECKER1)(CUR$.SL$.SL$)).ICONS)))) {
