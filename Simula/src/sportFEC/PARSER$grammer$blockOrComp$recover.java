...
public final class PARSER$grammer$blockOrComp$recover extends BASICIO$ {
    ...
    public PARSER$grammer$blockOrComp$recover STM$() {
        ...
        if(VALUE$((((PARSER$grammer)(CUR$.SL$.SL$)).cs==(((PARSER)(CUR$.SL$.SL$.SL$)).IEOP)))) {
            // JavaLine 28 ==> SourceLine 988
            {
                TRACE_BEGIN_STM$("CompoundStatement988",988);
                if(VALUE$(((((PARSER$grammer$blockOrComp)(CUR$.SL$)).blocktype==(((PARSER$grammer)(CUR$.SL$.SL$)).prefixblock))|(((((PARSER$grammer$blockOrComp)(CUR$.SL$)).blocktype==(((PARSER$grammer)(CUR$.SL$.SL$)).usualblock))&((!(((PARSER$grammer$blockOrComp)(CUR$.SL$)).unlabbody)))))))) {
        ...
        // JavaLine 45 ==> SourceLine 993
        {
            ...
            if(VALUE$((((PARSER$grammer$blockOrComp)(CUR$.SL$)).recoverno!=(3)))) {
