                    ...
                    try {
                        ...
                        while(true) {
                            // JavaLine 74 ==> SourceLine 1981
                            {
                                ...
                                if(VALUE$((((kind==(((CHECKER1)(CUR$.SL$.SL$)).K_ident))||((kind==(((CHECKER1)(CUR$.SL$.SL$)).K_label))))||((kind==(((CHECKER1)(CUR$.SL$.SL$)).K_error)))))) {
                                } else
                                // JavaLine 90 ==> SourceLine 1992
                                {
                                    TRACE_BEGIN_STM$("CompoundStatement1992",1992);
                                    if(VALUE$((((((ident.meaning.categ==(((CHECKER1)(CUR$.SL$.SL$)).C_local))||((ident.meaning.categ==(((CHECKER1)(CUR$.SL$.SL$)).C_extnal))))||((kind==(((CHECKER1)(CUR$.SL$.SL$)).K_array))))||((kind==(((CHECKER1)(CUR$.SL$.SL$)).K_rep))))||((kind==(((CHECKER1)(CUR$.SL$.SL$)).K_switch)))))) {
                                        // JavaLine 94 ==> SourceLine 1995
                                        testquant=ident.meaning;
                                    } else
                                    // JavaLine 97 ==> SourceLine 1996
                                    if(VALUE$(((ident.meaning.categ==(((CHECKER1)(CUR$.SL$.SL$)).C_virt))&((ident.meaning.descr!=(null)))))) {
                                ...
                                // JavaLine 174 ==> SourceLine 2039
                                {
                                        ...
                                        // JavaLine 199 ==> SourceLine 2055
                                        {
                                            ...
                                            while(((cquant!=(null))&&(inuse))) {
                                                // JavaLine 210 ==> SourceLine 2059
                                                {
                                                    ...
                                                    if(VALUE$((((CHECKER1$semchecker1)(CUR$.SL$)).exptop.p$ch==(((CHECKER1)(CUR$.SL$.SL$)).ICONS)))) {
                                                    } else
                                                    ...
                                                    if(VALUE$((cquant!=(null)))) {
                                                        // JavaLine 235 ==> SourceLine 2068
                                                        {
                                                            ...
                                                            if(VALUE$(((cquant.categ==(((CHECKER1)(CUR$.SL$.SL$)).C_local))||((cquant.categ==(((CHECKER1)(CUR$.SL$.SL$)).C_extnal)))))) {
                                    ...
                                    if(VALUE$(((testquant.kind==(((CHECKER1)(CUR$.SL$.SL$)).K_proc))&&((testquant.dim==(rank(((CHECKER1)(CUR$.SL$.SL$)).Cindex))))))) {
                            ...
                            if(VALUE$((noofexpargs==(((CHECKER1$semchecker1)(CUR$.SL$)).NargUnknown)))) {
