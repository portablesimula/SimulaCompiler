...
public final class CHECKER1$semchecker1$valuerel$emit extends BASICIO$ {
    ...
    public CHECKER1$semchecker1$valuerel$emit STM$() {
        ...
        if((((CHECKER1$semchecker1$valuerel)(CUR$.SL$)).opttype==(((CHECKER1)(CUR$.SL$.SL$.SL$)).ITEXT))) {
        ...
        // JavaLine 44 ==> SourceLine 362
        {
            ...
            if((((CHECKER1$semchecker1$valuerel)(CUR$.SL$)).opttype!=(((CHECKER1$semchecker1$valuerel)(CUR$.SL$)).p1$left.type))) {
            ...
            if((((CHECKER1$semchecker1$valuerel)(CUR$.SL$)).opttype!=(((CHECKER1$semchecker1$valuerel)(CUR$.SL$)).p1$right.type))) {
