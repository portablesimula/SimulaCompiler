                    ...
                    // JavaLine 61 ==> SourceLine 1249
                    {
                        ...
                        if(VALUE$(p$param)) {
                            // JavaLine 65 ==> SourceLine 1250
                            {
                                ...
                                if(VALUE$((p$Q.categ==(((BUILDER2)(CUR$.SL$.SL$.SL$.SL$)).C_local)))) {
                                    GOTO$(out); // GOTO EVALUATED LABEL
                                }
                                // JavaLine 71 ==> SourceLine 1251
                                if(VALUE$((p$Q.categ==(((BUILDER2)(CUR$.SL$.SL$.SL$.SL$)).C_extnal)))) {
                                    GOTO$(out); // GOTO EVALUATED LABEL
                                }
                        ...
                        if(VALUE$((p$Q.type==(((BUILDER2)(CUR$.SL$.SL$.SL$.SL$)).IREF)))) {
                            // JavaLine 80 ==> SourceLine 1254
                            {
                                ...
                                if(VALUE$((QX.categ==(((BUILDER2)(CUR$.SL$.SL$.SL$.SL$)).C_unknwn)))) {
                                    // JavaLine 109 ==> SourceLine 1262
                                    {
                                        TRACE_BEGIN_STM$("CompoundStatement1262",1262);
                                        if(VALUE$(IS$(p$Q,COMMON$quantity.class))) {
                                        ...
                                        if(VALUE$((QX.kind==(((BUILDER2)(CUR$.SL$.SL$.SL$.SL$)).K_record)))) {
                                ...
                                if(VALUE$((QX.kind!=(((BUILDER2)(CUR$.SL$.SL$.SL$.SL$)).K_class)))) {
                        ...
                        if(VALUE$(((p$Q.kind==(((BUILDER2)(CUR$.SL$.SL$.SL$.SL$)).K_class))||((p$Q.kind==(((BUILDER2)(CUR$.SL$.SL$.SL$.SL$)).K_record)))))) {
                            // JavaLine 163 ==> SourceLine 1278
                            {
                                TRACE_BEGIN_STM$("CompoundStatement1278",1278);
                                if(VALUE$((p$Q.prefqual==(null)))) {
                                    // JavaLine 167 ==> SourceLine 1279
                                    {
                                        TRACE_BEGIN_STM$("CompoundStatement1279",1279);
                                        if(VALUE$(((p$Q.ftag<(0))|((p$Q.line<(0)))))) {
