                    ...
                    // JavaLine 83 ==> SourceLine 535
                    {
                        ...
                        if(VALUE$((xtag>=(0)))) {
                            // JavaLine 89 ==> SourceLine 543
                            {
                                ...
                                if(VALUE$(((inspect$534$5.prefqual!=(null))&&(((inspect$534$5.kind!=(((BUILDER2)(CUR$.SL$.SL$)).K_class))||((inspect$534$5.plev>(((BUILDER2)(CUR$.SL$.SL$)).one)))))))) {
                                    // JavaLine 93 ==> SourceLine 544
                                    quallength=char$((TXT$.length(inspect$534$5.prefqual.symb.symbol)+(1)));
                                }
                                // JavaLine 96 ==> SourceLine 546
                                if(VALUE$(((inspect$534$5.encl.kind==(((BUILDER2)(CUR$.SL$.SL$)).K_proc))&&((inspect$534$5.categ<(((BUILDER2)(CUR$.SL$.SL$)).C_local)))))) {
                                } else
                                ...
                                if(VALUE$((((((BUILDER2$normalattrfile)(CUR$.SL$)).p+(rank(idlength)))+(rank(quallength)))>((((BUILDER2$normalattrfile)(CUR$.SL$)).bufmax-(5)))))) {
                                ...
                                if(VALUE$((quallength!=(((BUILDER2)(CUR$.SL$.SL$)).NUL)))) {
                                ...
                                if(VALUE$(((((BUILDER2$normalattrfile)(CUR$.SL$)).sysattrfile&&((inspect$534$5.categ!=(((BUILDER2)(CUR$.SL$.SL$)).C_virt))))&&((inspect$534$5.categ!=(((BUILDER2)(CUR$.SL$.SL$)).C_extnal)))))) {
                                    // JavaLine 122 ==> SourceLine 574
                                    {
                                        ...
                                        if(VALUE$((idlength==(((BUILDER2)(CUR$.SL$.SL$)).NUL)))) {
                                ...
                                if(VALUE$((inspect$534$5.protect!=(((char)0))))) {
                                ...
                                if(VALUE$((inspect$534$5.categ==(((BUILDER2)(CUR$.SL$.SL$)).C_extnal)))) {
                                    // JavaLine 231 ==> SourceLine 622
                                    {
                                        TRACE_BEGIN_STM$("CompoundStatement622",622);
                                        if(VALUE$(IS$(inspect$534$5.descr,COMMON$extbrecord.class))) {
                                ...
                                // JavaLine 265 ==> SourceLine 635
                                {
                                    ...
                                    if(VALUE$(((inspect$534$5.encl!=(null))&&(((inspect$534$5.categ!=(((BUILDER2)(CUR$.SL$.SL$)).C_local))||(((inspect$534$5.match!=(null))&&((inspect$534$5.match.categ==(((BUILDER2)(CUR$.SL$.SL$)).C_virt)))))))))) {
                                ...
                                if(VALUE$(((inspect$534$5.special!=(((BUILDER2)(CUR$.SL$.SL$)).NUL))||((inspect$534$5.kind==(((BUILDER2)(CUR$.SL$.SL$)).K_rep)))))) {
                                    // JavaLine 286 ==> SourceLine 648
                                    {
                                        ...
                                        if(VALUE$((inspect$534$5.kind==(((BUILDER2)(CUR$.SL$.SL$)).K_rep)))) {
                                        ...
                                        // JavaLine 301 ==> SourceLine 653
                                        {
                                            ...
                                            if(VALUE$((inspect$534$5.descr.blnohi!=(((BUILDER2)(CUR$.SL$.SL$)).NUL)))) {
                                ...
                                if(VALUE$((!(((BUILDER2$normalattrfile)(CUR$.SL$)).sysattrfile)))) {
                                    // JavaLine 331 ==> SourceLine 667
                                    {
                                        TRACE_BEGIN_STM$("CompoundStatement667",667);
                                        {
                                            ...
                                            // JavaLine 338 ==> SourceLine 668
                                            {
                                                ...
                                                if(VALUE$((inspect$667$8.connests!=(((BUILDER2)(CUR$.SL$.SL$)).zero)))) {
                                                ...
                                                if(VALUE$(inspect$667$8.thisused)) {
                                                    k=64;
                                                } else
                                                k=0;
                                                // JavaLine 356 ==> SourceLine 674
                                                if(VALUE$(inspect$667$8.hasCode)) {
                                                    k=(k+(32));
                                                }
                                                // JavaLine 360 ==> SourceLine 676
                                                if(VALUE$((inspect$667$8.inrtag!=(((BUILDER2)(CUR$.SL$.SL$)).NUL)))) {
                                                    k=(k+(2));
                                                }
                                ...
                                if(VALUE$((((clf==(((BUILDER2)(CUR$.SL$.SL$)).Clf004))||((clf==(((BUILDER2)(CUR$.SL$.SL$)).Clf009))))&&(inrflag)))) {
                                ...
                                if(VALUE$(IS$(inspect$534$5.descr,COMMON$brecord.class))) {
                                    {
                                        TRACE_BEGIN_STM$("CompoundStatement685",685);
                                        if(VALUE$((inspect$534$5.special==(((BUILDER2)(CUR$.SL$.SL$)).NUL)))) {
                                            // JavaLine 395 ==> SourceLine 686
                                            {
                                                TRACE_BEGIN_STM$("CompoundStatement686",686);
                                                if(VALUE$((inspect$534$5.descr.kind==(((BUILDER2)(CUR$.SL$.SL$)).K_class)))) {
                                                ...
                                                if(VALUE$(((inspect$534$5.categ==(((BUILDER2)(CUR$.SL$.SL$)).C_virt))&&((inspect$534$5.kind==(((BUILDER2)(CUR$.SL$.SL$)).K_proc)))))) {
