    ...
    public RTObject$ STM$() {
        ...
        LOOP$:while(JTX$>=0) {
            try {
                ...
                if(VALUE$(((((BUILDER2$prechecker$allocate$alloc2)(CUR$.SL$)).inspect$1419$15.declquant.type!=(((BUILDER2$prechecker$allocate$alloc2)(CUR$.SL$)).VA.type))||((((BUILDER2$prechecker$allocate$alloc2)(CUR$.SL$)).inspect$1419$15.declquant.prefqual!=(((BUILDER2$prechecker$allocate$alloc2)(CUR$.SL$)).VA.prefqual)))))) {
                ...
                while((specPar!=(null))) {
                    // JavaLine 42 ==> SourceLine 1432
                    {
                        ...
                        if(VALUE$((actPar==(null)))) {
                            GOTO$(Actcnt); // GOTO EVALUATED LABEL
                        }
                        // JavaLine 48 ==> SourceLine 1434
                        if(VALUE$(((((specPar.type!=(actPar.type))||((specPar.kind!=(actPar.kind))))||((specPar.categ!=(actPar.categ))))||((specPar.prefqual!=(actPar.prefqual)))))) {
