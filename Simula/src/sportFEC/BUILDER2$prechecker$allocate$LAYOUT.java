    ...
    public BUILDER2$prechecker$allocate$LAYOUT STM$() {
        ...
        LOOP$:while(JTX$>=0) {
            try {
                ...
                if(VALUE$((p$brc.kind!=(((BUILDER2)(CUR$.SL$.SL$.SL$)).K_labbl)))) {
                    // JavaLine 53 ==> SourceLine 1543
                    {
                        TRACE_BEGIN_STM$("CompoundStatement1543",1543);
                        if(VALUE$((p$brc.kind!=(((BUILDER2)(CUR$.SL$.SL$.SL$)).K_extnal)))) {
                            // JavaLine 57 ==> SourceLine 1545
                            {
                                TRACE_BEGIN_STM$("CompoundStatement1545",1545);
                                if(VALUE$(IS$(p$brc.declquant,COMMON$quantity.class))) {
                                    // JavaLine 61 ==> SourceLine 1546
                                    {
                                        ...
                                        if(VALUE$(((p$brc.kind==(((BUILDER2)(CUR$.SL$.SL$.SL$)).K_proc))&&((p$brc.declquant.plev==(2)))))) {
                                        } else
                                        // JavaLine 68 ==> SourceLine 1553
                                        if(VALUE$((((p$brc.kind==(((BUILDER2)(CUR$.SL$.SL$.SL$)).K_class))||((p$brc.kind==(((BUILDER2)(CUR$.SL$.SL$.SL$)).K_prefbl))))||((p$brc.kind==(((BUILDER2)(CUR$.SL$.SL$.SL$)).K_record)))))) {
                                        ...
                                        // JavaLine 80 ==> SourceLine 1563
                                        {
                                            ...
                                            if(VALUE$(((p$brc.kind==(((BUILDER2)(CUR$.SL$.SL$.SL$)).K_subbl))||((p$brc.kind==(((BUILDER2)(CUR$.SL$.SL$.SL$)).K_proc)))))) {
                                            ...
                                            if(VALUE$(((BUILDER2)(CUR$.SL$.SL$.SL$)).simob_descr)) {
                                                // JavaLine 91 ==> SourceLine 1566
                                                {
                                                    TRACE_BEGIN_STM$("CompoundStatement1566",1566);
                                                    if(VALUE$(((p$brc.kind==(((BUILDER2)(CUR$.SL$.SL$.SL$)).K_class))||((p$brc.kind==(((BUILDER2)(CUR$.SL$.SL$.SL$)).K_proc)))))) {
                                ...
                                if(VALUE$((((COMMON$extquantity)(p$brc.declquant)).p2$module==(null)))) {
                ...
                while((q!=(null))) {
                    // JavaLine 135 ==> SourceLine 1590
                    {
                        ...
                        if(VALUE$(IS$(q,COMMON$extquantity.class))) {
                            // JavaLine 139 ==> SourceLine 1591
                            {
                                TRACE_BEGIN_STM$("CompoundStatement1591",1591);
                                if(VALUE$((((COMMON$extquantity)(q)).clf<=(((BUILDER2)(CUR$.SL$.SL$.SL$)).Clf002)))) {
                                    // JavaLine 143 ==> SourceLine 1592
                                    {
                                        ...
                                        if(VALUE$((((COMMON$extquantity)(q)).p2$module!=(null)))) {
                        ...
                        if(VALUE$((((((q.kind==(((BUILDER2)(CUR$.SL$.SL$.SL$)).K_proc))&&((q.categ==(((BUILDER2)(CUR$.SL$.SL$.SL$)).C_local))))||((q.kind==(((BUILDER2)(CUR$.SL$.SL$.SL$)).K_rep))))||((q.kind==(((BUILDER2)(CUR$.SL$.SL$.SL$)).K_class))))||((q.kind==(((BUILDER2)(CUR$.SL$.SL$.SL$)).K_record)))))) {
                            // JavaLine 185 ==> SourceLine 1613
                            new BUILDER2$prechecker$allocate$LAYOUT(((BUILDER2$prechecker$allocate)(CUR$.SL$)),q.descr);
                        } else
                        if(VALUE$(((q.special>(((char)1)))&&((q.type!=(((BUILDER2)(CUR$.SL$.SL$.SL$)).ITEXT)))))) {
                        } else
                        // JavaLine 190 ==> SourceLine 1615
                        {
                            ...
                            if(VALUE$((q.categ==(((BUILDER2)(CUR$.SL$.SL$.SL$)).C_name)))) {
                                new BUILDER1$newTag(((BUILDER2)(CUR$.SL$.SL$.SL$)));
                            }
