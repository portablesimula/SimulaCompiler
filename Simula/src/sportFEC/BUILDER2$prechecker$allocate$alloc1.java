    ...
    public BUILDER2$prechecker$allocate$alloc1 STM$() {
        ...
        LOOP$:while(JTX$>=0) {
            try {
                ...
                if(VALUE$((rank(p$brc.blev)>(((BUILDER2)(CUR$.SL$.SL$.SL$)).maxblev)))) {
                ...
                while((Q!=(null))) {
                    // JavaLine 67 ==> SourceLine 1041
                    {
                        ...
                        if(VALUE$((Q.categ!=(((BUILDER2)(CUR$.SL$.SL$.SL$)).C_extnal)))) {
                            QX=Q;
                        } else
                        ...
                        if(VALUE$((QN.kind==(((BUILDER2)(CUR$.SL$.SL$.SL$)).K_unknwn)))) {
                        ...
                        // JavaLine 152 ==> SourceLine 1075
                        {
                            ...
                            // JavaLine 157 ==> SourceLine 1078
                            {
                                ...
                                if(VALUE$((Q.descr!=(p$brc)))) {
                                    // JavaLine 161 ==> SourceLine 1079
                                    {
                                        TRACE_BEGIN_STM$("CompoundStatement1079",1079);
                                        if(VALUE$((((QN.kind==(((BUILDER2)(CUR$.SL$.SL$.SL$)).K_proc))||((QN.kind==(((BUILDER2)(CUR$.SL$.SL$.SL$)).K_class))))||((QN.kind==(((BUILDER2)(CUR$.SL$.SL$.SL$)).K_record)))))) {
                            ...
                            // JavaLine 174 ==> SourceLine 1084
                            {
                                ...
                                if(VALUE$((p$brc.kind==(((BUILDER2)(CUR$.SL$.SL$.SL$)).K_class)))) {
                                    // JavaLine 178 ==> SourceLine 1087
                                    {
                                        ...
                                        if(VALUE$(((QN.kind==(((BUILDER2)(CUR$.SL$.SL$.SL$)).K_proc))|((QN.type==(((BUILDER2)(CUR$.SL$.SL$.SL$)).ILABE)))))) {
                                ...
                                if(VALUE$(extbinding)) {
                                    // JavaLine 190 ==> SourceLine 1091
                                    {
                                        ...
                                        if(VALUE$(((QN.kind==(((BUILDER2)(CUR$.SL$.SL$.SL$)).K_proc))|((QN.kind==(((BUILDER2)(CUR$.SL$.SL$.SL$)).K_switch)))))) {
                            ...
                            // JavaLine 205 ==> SourceLine 1098
                            {
                                ...
                                if(VALUE$((((QN.type<=(((BUILDER2)(CUR$.SL$.SL$.SL$)).ILONG))||((QN.type==(((BUILDER2)(CUR$.SL$.SL$.SL$)).IELSE))))&&(((QN.kind==(((BUILDER2)(CUR$.SL$.SL$.SL$)).K_ident))||((QN.kind==(((BUILDER2)(CUR$.SL$.SL$.SL$)).K_array)))))))) {
                                    // JavaLine 209 ==> SourceLine 1101
                                    {
                                        TRACE_BEGIN_STM$("CompoundStatement1101",1101);
                                        if(VALUE$((QN.kind==(((BUILDER2)(CUR$.SL$.SL$.SL$)).K_ident)))) {
                                ...
                                if(VALUE$(((QN.type!=(((BUILDER2)(CUR$.SL$.SL$.SL$)).ITEXT))||((QN.kind!=(((BUILDER2)(CUR$.SL$.SL$.SL$)).K_ident)))))) {
                            ...
                            // JavaLine 228 ==> SourceLine 1107
                            {
                                ...
                                if(VALUE$(extbinding)) {
                                    // JavaLine 236 ==> SourceLine 1112
                                    {
                                        ...
                                        if(VALUE$((QN.type==(((BUILDER2)(CUR$.SL$.SL$.SL$)).ILABE)))) {
                    ...
                    if(VALUE$((QN.kind==(((BUILDER2)(CUR$.SL$.SL$.SL$)).K_class)))) {
