    ...
    public PARSER$grammer$readclasspar$classparerror STM$() {
        ...
        LOOP$:while(JTX$>=0) {
            try {
                ...
                if((((PARSER$grammer)(CUR$.SL$.SL$)).cs==(((PARSER)(CUR$.SL$.SL$.SL$)).IVIRT))) {
                    GOTO$(((PARSER$grammer$readclasspar)(CUR$.SL$)).virtualspec); // GOTO EVALUATED LABEL
                }
                // JavaLine 72 ==> SourceLine 445
                if((((((PARSER$grammer)(CUR$.SL$.SL$)).cs==(((PARSER)(CUR$.SL$.SL$.SL$)).IHIDD))|((((PARSER$grammer)(CUR$.SL$.SL$)).cs==(((PARSER)(CUR$.SL$.SL$.SL$)).IPRTC))))|((((PARSER$grammer)(CUR$.SL$.SL$)).cs==(((PARSER)(CUR$.SL$.SL$.SL$)).ITO))))) {
