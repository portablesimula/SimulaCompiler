...
public final class BUILDER2$recompattrfile$outquantwlist extends BASICIO$ {
    ...
    // JavaLine 12 ==> SourceLine 914
    final LABQNT$ UTQ=new LABQNT$(this,0,1); // Local Label #1=UTQ
    // JavaLine 14 ==> SourceLine 920
    final LABQNT$ UTP=new LABQNT$(this,0,2); // Local Label #2=UTP
                    ...
                    // JavaLine 70 ==> SourceLine 813
                    {
                        ...
                        if(VALUE$((k>(-2)))) {
                            // JavaLine 76 ==> SourceLine 817
                            {
                                ...
                                if(VALUE$((((BUILDER2$recompattrfile)(CUR$.SL$)).key>=(((BUILDER2$recompattrfile)(CUR$.SL$)).lowKey)))) {
                                ...
                                if(VALUE$(((inspect$812$9.symb!=(((BUILDER2$recompattrfile)(CUR$.SL$)).xident))&&(((inspect$812$9.encl.kind!=(((BUILDER2)(CUR$.SL$.SL$)).K_proc))||((inspect$812$9.categ>=(((BUILDER2)(CUR$.SL$.SL$)).C_local)))))))) {
                                    // JavaLine 86 ==> SourceLine 822
                                    l=388;
                                } else
                                // JavaLine 89 ==> SourceLine 823
                                if(VALUE$((((BUILDER2$recompattrfile)(CUR$.SL$)).xprotect!=(inspect$812$9.protect)))) {
                                    l=385;
                                } else
                                // JavaLine 93 ==> SourceLine 824
                                if(VALUE$((((BUILDER2$recompattrfile)(CUR$.SL$)).xtype!=(inspect$812$9.type)))) {
                                    l=371;
                                } else
                                // JavaLine 97 ==> SourceLine 825
                                if(VALUE$((((BUILDER2$recompattrfile)(CUR$.SL$)).xkind!=(inspect$812$9.kind)))) {
                                    l=372;
                                } else
                                // JavaLine 101 ==> SourceLine 826
                                if(VALUE$((((BUILDER2$recompattrfile)(CUR$.SL$)).xcateg!=(inspect$812$9.categ)))) {
                                    l=373;
                                } else
                                // JavaLine 105 ==> SourceLine 827
                                if(VALUE$((((BUILDER2$recompattrfile)(CUR$.SL$)).xclf!=(((IS$(((COMMON$quantity)inspect$812$9),COMMON$extquantity.class))?(((COMMON$extquantity)(((COMMON$quantity)inspect$812$9))).clf):(((BUILDER2)(CUR$.SL$.SL$)).Clf000)))))) {
                                    // JavaLine 107 ==> SourceLine 829
                                    l=378;
                                } else
                                // JavaLine 110 ==> SourceLine 830
                                if(VALUE$((k!=(((BUILDER2$recompattrfile)(CUR$.SL$)).xftag)))) {
                                    l=379;
                                } else
                                ...
                                if(VALUE$((inspect$812$9.categ!=(((BUILDER2)(CUR$.SL$.SL$)).C_extnal)))) {
                                    // JavaLine 127 ==> SourceLine 836
                                    {
                                        TRACE_BEGIN_STM$("CompoundStatement836",836);
                                        if(VALUE$(((((BUILDER2$recompattrfile)(CUR$.SL$)).xdim!=(inspect$812$9.dim))&&((inspect$812$9.dim>=(0)))))) {
                                ...
                                if(VALUE$((inspect$812$9.categ==(((BUILDER2)(CUR$.SL$.SL$)).C_extnal)))) {
                                    // JavaLine 149 ==> SourceLine 859
                                    {
                                        ...
                                        if(VALUE$((((BUILDER2$recompattrfile)(CUR$.SL$)).xlanguage!=(inspect$812$9.dim)))) {
                                        ...
                                        if(VALUE$((((BUILDER2$recompattrfile)(CUR$.SL$)).xextident!=(inspect$812$9.virtno)))) {
                                        ...
                                        if(VALUE$(IS$(inspect$812$9.descr,COMMON$extbrecord.class))) {
                                            // JavaLine 161 ==> SourceLine 863
                                            {
                                                ...
                                                // JavaLine 166 ==> SourceLine 864
                                                {
                                                    ...
                                                    if(VALUE$(((((BUILDER2$recompattrfile)(CUR$.SL$)).xmodulhi!=(inspect$863$10.modulhi))||((((BUILDER2$recompattrfile)(CUR$.SL$)).xmodullo!=(inspect$863$10.modullo)))))) {
                                                    ...
                                                    if(VALUE$(((((BUILDER2$recompattrfile)(CUR$.SL$)).xchecklo!=(inspect$863$10.checklo))||((((BUILDER2$recompattrfile)(CUR$.SL$)).xcheckhi!=(inspect$863$10.checkhi)))))) {
                                ...
                                // JavaLine 185 ==> SourceLine 871
                                {
                                    ...
                                    // JavaLine 190 ==> SourceLine 872
                                    {
                                        ...
                                        if(VALUE$((inspect$871$11.thisused&&((!(((BUILDER2$recompattrfile)(CUR$.SL$)).xthisused)))))) {
                                        ...
                                        if(VALUE$((((BUILDER2$recompattrfile)(CUR$.SL$)).xconnests!=(char$(inspect$871$11.connests))))) {
                                        ...
                                        if(VALUE$((inspect$871$11.hidlist==(null)))) {
                                            // JavaLine 202 ==> SourceLine 879
                                            {
                                                TRACE_BEGIN_STM$("CompoundStatement879",879);
                                                if(VALUE$((((BUILDER2$recompattrfile)(CUR$.SL$)).xhidlist!=(null)))) {
                                ...
                                if(VALUE$(((inspect$812$9.special==(((BUILDER2)(CUR$.SL$.SL$)).NUL))&&(IS$(inspect$812$9.descr,COMMON$brecord.class))))) {
                                    // JavaLine 217 ==> SourceLine 899
                                    {
                                        TRACE_BEGIN_STM$("CompoundStatement899",899);
                                        l=k=0;
                                        // JavaLine 221 ==> SourceLine 900
                                        if(VALUE$(((inspect$812$9.categ==(((BUILDER2)(CUR$.SL$.SL$)).C_virt))&&((inspect$812$9.kind==(((BUILDER2)(CUR$.SL$.SL$)).K_proc)))))) {
                                        ...
                                        // JavaLine 233 ==> SourceLine 913
                                        {
                                            ...
                                            while((qq!=(null))) {
                                                // JavaLine 241 ==> SourceLine 915
                                                {
                                                    ...
                                                    if(VALUE$((((k==(0)))?((qq.dim!=(0))):(((IS$(qq.descr,COMMON$extbrecord.class))?((((COMMON$extbrecord)(qq.descr)).status==('S'))):(true)))))) {
                                            ...
                                            if(VALUE$((l!=(0)))) {
                                                // JavaLine 281 ==> SourceLine 928
                                                {
                                                    ...
                                                    if(VALUE$((((BUILDER2$recompattrfile)(CUR$.SL$)).key!=(((BUILDER2$recompattrfile)(CUR$.SL$)).endlist)))) {
