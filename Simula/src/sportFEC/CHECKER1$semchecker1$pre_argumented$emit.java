        ...
        LOOP$:while(JTX$>=0) {
            try {
                JUMPTABLE$(JTX$); // For ByteCode Engineering
                {
                    ...
                    if(VALUE$(((inspect$1738$14.meaning!=(null))||((((CHECKER1$semchecker1$pre_argumented)(CUR$.SL$)).p$ch!=(((CHECKER1)(CUR$.SL$.SL$.SL$)).IBPRF)))))) {
            ...
            if(VALUE$((((CHECKER1$semchecker1$pre_argumented)(CUR$.SL$)).p1$ident.kind==(((CHECKER1)(CUR$.SL$.SL$.SL$)).K_error)))) {
            } else
            // JavaLine 97 ==> SourceLine 1761
            if(VALUE$((((CHECKER1$semchecker1$pre_argumented)(CUR$.SL$)).p$ch==(((CHECKER1)(CUR$.SL$.SL$.SL$)).IBPRF)))) {
