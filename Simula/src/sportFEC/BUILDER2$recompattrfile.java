    ...
    public BUILDER2$recompattrfile(RTObject$ staticLink) {
        ...
        CODE$=new ClassBody(CODE$,this,1) {
            public void STM$() {
                ...
                if(TXTREL$NE(((BUILDER2)(CUR$.SL$)).simsymbol,((BUILDER2)(CUR$.SL$)).moduleident)) {
                ...
                if(((key!=(mainKey))||((new COMMON$attrfile$nextNumber(((BUILDER2$recompattrfile)CUR$)).RESULT$!=(((BUILDER2)(CUR$.SL$)).nextexttag))))) {
