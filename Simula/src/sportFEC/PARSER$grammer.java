...
public class PARSER$grammer extends COMMON$component {
    ...
    // JavaLine 20 ==> SourceLine 2330
    final LABQNT$ AssStm=new LABQNT$(this,1,5); // Local Label #5=AssStm
    // JavaLine 22 ==> SourceLine 2353
    final LABQNT$ testcallorobjgen=new LABQNT$(this,1,6); // Local Label #6=testcallorobjgen
    // JavaLine 24 ==> SourceLine 2296
    final LABQNT$ XorB=new LABQNT$(this,1,7); // Local Label #7=XorB
    // JavaLine 26 ==> SourceLine 2396
    final LABQNT$ ROattr=new LABQNT$(this,1,8); // Local Label #8=ROattr
    // JavaLine 28 ==> SourceLine 2412
    final LABQNT$ reper1=new LABQNT$(this,1,9); // Local Label #9=reper1
    // JavaLine 30 ==> SourceLine 2369
    final LABQNT$ d1=new LABQNT$(this,1,10); // Local Label #10=d1
    // JavaLine 32 ==> SourceLine 2431
    final LABQNT$ testSmcl=new LABQNT$(this,1,11); // Local Label #11=testSmcl
    // JavaLine 34 ==> SourceLine 2466
    final LABQNT$ A21=new LABQNT$(this,1,12); // Local Label #12=A21
    // JavaLine 36 ==> SourceLine 2472
    final LABQNT$ A30=new LABQNT$(this,1,13); // Local Label #13=A30
    // JavaLine 38 ==> SourceLine 2473
    final LABQNT$ A3=new LABQNT$(this,1,14); // Local Label #14=A3
    // JavaLine 40 ==> SourceLine 2454
    final LABQNT$ A1=new LABQNT$(this,1,15); // Local Label #15=A1
    // JavaLine 42 ==> SourceLine 2465
    final LABQNT$ A2=new LABQNT$(this,1,16); // Local Label #16=A2
    // JavaLine 44 ==> SourceLine 2438
    final LABQNT$ arrdcl=new LABQNT$(this,1,17); // Local Label #17=arrdcl
    ...
    // JavaLine 50 ==> SourceLine 2625
    final LABQNT$ actError=new LABQNT$(this,1,20); // Local Label #20=actError
    // JavaLine 52 ==> SourceLine 2620
    final LABQNT$ actv=new LABQNT$(this,1,21); // Local Label #21=actv
            ...
            public void STM$() {
                ...
                LOOP$:while(JTX$>=0) {
                    try {
                        ...
                        if(((last.blockstatus==(stmtnotseen))||(((stmtwnt==(classbody))||((stmtwnt==(procbody))))))) {
                ...
                // JavaLine 442 ==> SourceLine 2362
                {
                    ...
                    if(((!(last.isblocklike))||((last.blockstatus==(lastwasstmt))))) {
                    ...
                    if((((PARSER)(CUR$.SL$)).option.Elt[rank('I')-((PARSER)(CUR$.SL$)).option.LB[0]]!=(((PARSER)(CUR$.SL$)).NUL))) {
                        // JavaLine 495 ==> SourceLine 2382
                        new PARSER$grammer$lookforstring(((PARSER$grammer)CUR$));
                    } else
                    if((cs==(((PARSER)(CUR$.SL$)).IEQ))) {
                        // JavaLine 499 ==> SourceLine 2383
                        {
                            TRACE_BEGIN_STM$("CompoundStatement2383",2383);
                            if(((readtype==(((PARSER)(CUR$.SL$)).IREAL))|((readtype==(((PARSER)(CUR$.SL$)).ILONG))))) {
                    ...
                    if(((cs==(((PARSER)(CUR$.SL$)).IASSG))||((cs==(((PARSER)(CUR$.SL$)).IDENO))))) {
                        // JavaLine 529 ==> SourceLine 2391
                        {
                            TRACE_BEGIN_STM$("CompoundStatement2391",2391);
                            if((!(((PARSER)(CUR$.SL$)).SportOK))) {
                        ...
                        // JavaLine 561 ==> SourceLine 2403
                        {
                            ...
                            if(((PARSER)(CUR$.SL$)).Simuletta) {
                                // JavaLine 565 ==> SourceLine 2404
                                {
                                    ...
                                    if((((PARSER)(CUR$.SL$)).optx!=(((PARSER)(CUR$.SL$)).IINTG))) {
                                    ...
                                    if(((((PARSER)(CUR$.SL$)).repcount<=(0))||((((PARSER)(CUR$.SL$)).repcount>(((PARSER)(CUR$.SL$)).RepeatMax))))) {
                    ...
                    if(((cs!=(((PARSER)(CUR$.SL$)).ISMCL))&&((cs!=(((PARSER)(CUR$.SL$)).IEOP))))) {
                ...
                // JavaLine 649 ==> SourceLine 2436
                {
                    ...
                    while((cs==(((PARSER)(CUR$.SL$)).ICOMA))) {
                        // JavaLine 688 ==> SourceLine 2451
                        {
                            ...
                            if((new PARSER$grammer$notBoundPair(((PARSER$grammer)CUR$),((PARSER)(CUR$.SL$)).IBNDE).RESULT$==(0))) {
                ...
                // JavaLine 896 ==> SourceLine 2519
                {
                    ...
                    if((!(labelused))) {
                        // JavaLine 908 ==> SourceLine 2524
                        {
                            ...
                            if(((stmtwnt!=(procbody))&&((stmtwnt!=(classbody))))) {
                    ...
                    if((last.isblocklike&&((last.blockstatus==(stmtnotseen))))) {
                        // JavaLine 920 ==> SourceLine 2530
                        {
                            ...
                            if(((stmtwnt!=(outermost))||((!(((PARSER)(CUR$.SL$)).separatecomp))))) {
                ...
                // JavaLine 1099 ==> SourceLine 2618
                {
                    ...
                    // JavaLine 1108 ==> SourceLine 2623
                    {
                        ...
                        // JavaLine 1113 ==> SourceLine 2624
                        {
                            ...
                            if(((cs==(((PARSER)(CUR$.SL$)).IBEFO))|((cs==(((PARSER)(CUR$.SL$)).IAFTR))))) {
