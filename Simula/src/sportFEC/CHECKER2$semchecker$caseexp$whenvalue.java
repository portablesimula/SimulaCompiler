    ...
    public CHECKER2$semchecker$caseexp$whenvalue STM$() {
        ...
        if((((CHECKER2$semchecker$caseexp)(CUR$.SL$)).p1$casetype!=(((CHECKER2)(CUR$.SL$.SL$.SL$)).IELSE))) {
            // JavaLine 43 ==> SourceLine 298
            {
                ...
                if(((p$i<(((CHECKER2$semchecker$caseexp)(CUR$.SL$)).p1$lb))|((((CHECKER2$semchecker$caseexp)(CUR$.SL$)).p1$ub<(p$i))))) {
                ...
                } else
                {
                    ...
                    if(((CHECKER2$semchecker$caseexp)(CUR$.SL$)).seen.Elt[p$i-((CHECKER2$semchecker$caseexp)(CUR$.SL$)).seen.LB[0]]) {
