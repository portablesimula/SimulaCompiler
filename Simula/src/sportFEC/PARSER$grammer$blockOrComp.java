                    ...
                    try {
                        ...
                        if((caller.stmtreq==(((PARSER$grammer)(CUR$.SL$)).outermost))) {
                            // JavaLine 62 ==> SourceLine 1027
                            {
                                ...
                                if(IS$(((PARSER)(CUR$.SL$.SL$)).coder,PARSER$codebuffer.class)) {
                        ...
                        if(((PARSER$grammer)(CUR$.SL$)).ex.startexprstmt) {
                        ...
                        if(((((PARSER$grammer)(CUR$.SL$)).symboltype.Elt[rank(((PARSER$grammer)(CUR$.SL$)).cs)-((PARSER$grammer)(CUR$.SL$)).symboltype.LB[0]]==(((PARSER$grammer)(CUR$.SL$)).declsymbol))||(((((PARSER$grammer)(CUR$.SL$)).cs==(((PARSER)(CUR$.SL$.SL$)).IIDN))&&(((((PARSER)(CUR$.SL$.SL$)).opt==(((PARSER)(CUR$.SL$.SL$)).ICLAS))||((((PARSER)(CUR$.SL$.SL$)).opt==(((PARSER)(CUR$.SL$.SL$)).IRCRD))))))))) {
                        ...
                        if((stmttype==(((PARSER$grammer)(CUR$.SL$)).declunit))) {
                        ...
                        if((stmttype!=(((PARSER$grammer)(CUR$.SL$)).dummystmt))) {
                            blockstatus=((PARSER$grammer)(CUR$.SL$)).lastwasstmt;
                        }
                        ...
                        if(((blocktype==(((PARSER$grammer)(CUR$.SL$)).prefixblock))|(((blocktype==(((PARSER$grammer)(CUR$.SL$)).usualblock))&((!(unlabbody))))))) {
                        ...
                        if((caller.stmtreq==(((PARSER$grammer)(CUR$.SL$)).classbody))) {
