...
public final class PARSER$grammer$readprocpar extends BASICIO$ {
    ...
    // JavaLine 12 ==> SourceLine 396
    final LABQNT$ P1=new LABQNT$(this,0,1); // Local Label #1=P1
    // JavaLine 14 ==> SourceLine 404
    final LABQNT$ checksemic=new LABQNT$(this,0,2); // Local Label #2=checksemic
    // JavaLine 16 ==> SourceLine 406
    final LABQNT$ namevaluepart=new LABQNT$(this,0,3); // Local Label #3=namevaluepart
    // JavaLine 18 ==> SourceLine 409
    final LABQNT$ P3=new LABQNT$(this,0,4); // Local Label #4=P3
    // JavaLine 20 ==> SourceLine 410
    final LABQNT$ P2=new LABQNT$(this,0,5); // Local Label #5=P2
    ...
    public PARSER$grammer$readprocpar STM$() {
        ...
        LOOP$:while(JTX$>=0) {
            try {
                ...
                if(VALUE$((((PARSER$grammer)(CUR$.SL$)).cs==(((PARSER)(CUR$.SL$.SL$)).ILFPA)))) {
                    // JavaLine 69 ==> SourceLine 396
                    {
                        ...
                        if(VALUE$((((PARSER$grammer)(CUR$.SL$)).cs!=(((PARSER)(CUR$.SL$.SL$)).IRGPA)))) {
                        ...
                        LABEL$(3,"namevaluepart");
                        // JavaLine 108 ==> SourceLine 406
                        if(VALUE$((((PARSER$grammer)(CUR$.SL$)).cs==(((PARSER)(CUR$.SL$.SL$)).IVALU)))) {
                        ...
                        if(VALUE$((((PARSER$grammer)(CUR$.SL$)).cs==(((PARSER)(CUR$.SL$.SL$)).INAME)))) {
                            // JavaLine 144 ==> SourceLine 417
                            {
                                TRACE_BEGIN_STM$("CompoundStatement417",417);
                                if(VALUE$((p$speckind==(((PARSER)(CUR$.SL$.SL$)).ICSPC)))) {
                ...
                if(VALUE$(((PARSER$grammer)(CUR$.SL$)).specofvirtual)) {
                } else
    ...
    public static PROGINFO$ INFO$=new PROGINFO$("PARSER.DEF","Procedure readprocpar",1,349,12,396,14,404,16,406,18,409,20,410,22,421,24,428,27,352,29,353,65,394,67,395,69,396,74,397,78,398,81,399,84,400,88,401,92,402,96,403,98,405,100,404,102,405,106,415,108,406,110,407,116,408,118,409,121,410,124,411,128,412,131,413,134,414,142,416,144,417,148,418,154,419,160,421,163,422,170,424,174,425,180,429,182,428,185,429,192,430,210,431);
}
