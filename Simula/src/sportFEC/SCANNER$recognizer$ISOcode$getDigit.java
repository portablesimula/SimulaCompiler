...
public final class SCANNER$recognizer$ISOcode$getDigit extends BASICIO$ {
    ...
    public SCANNER$recognizer$ISOcode$getDigit STM$() {
        ...
        if(VALUE$((((SCANNER$recognizer)(CUR$.SL$.SL$)).InputClass.Elt[rank(((SCANNER$recognizer)(CUR$.SL$.SL$)).atom)-((SCANNER$recognizer)(CUR$.SL$.SL$)).InputClass.LB[0]]==(((SCANNER)(CUR$.SL$.SL$.SL$)).Digit_cl)))) {
