...
public class PARSER$grammer$forstat extends PARSER$grammer$statement {
    ...
    // JavaLine 14 ==> SourceLine 1517
    final LABQNT$ S0=new LABQNT$(this,1,2); // Local Label #2=S0
    // JavaLine 16 ==> SourceLine 1532
    final LABQNT$ forelem=new LABQNT$(this,1,3); // Local Label #3=forelem
    // JavaLine 18 ==> SourceLine 1621
    final LABQNT$ exprErr=new LABQNT$(this,1,4); // Local Label #4=exprErr
    // JavaLine 20 ==> SourceLine 1665
    final LABQNT$ PARSE=new LABQNT$(this,1,5); // Local Label #5=PARSE
    ...
    public PARSER$codebuffer inspect$1514$6=null;
    // JavaLine 39 ==> SourceLine 1551
    public PARSER$codebuffer$elt inspect$1551$7=null;
    // JavaLine 41 ==> SourceLine 1570
    public PARSER$codebuffer$elt inspect$1570$8=null;
    // JavaLine 43 ==> SourceLine 1594
    public PARSER$codebuffer$elt inspect$1594$9=null;
    // JavaLine 45 ==> SourceLine 1645
    public PARSER$codebuffer$elt inspect$1645$10=null;
            ...
            public void STM$() {
                ...
                LOOP$:while(JTX$>=0) {
                    try {
                        ...
                        {
                            // BEGIN INSPECTION 
                            inspect$1514$6=forcoder;
                            if(inspect$1514$6!=null) //INSPECT inspect$1514$6
                            // JavaLine 73 ==> SourceLine 1517
                            {
                                ...
                                inspect$1514$6.wheeler=inspect$1514$6.curelt;
                                // JavaLine 95 ==> SourceLine 1524
                                if(VALUE$(((((PARSER)(CUR$.SL$.SL$)).opt!=(((PARSER)(CUR$.SL$.SL$)).IASSG))&&((((PARSER)(CUR$.SL$.SL$)).opt!=(((PARSER)(CUR$.SL$.SL$)).IDENO)))))) {
                                ...
                                call(forcoder);
                                inspect$1514$6.cvar=inspect$1514$6.curelt;
                                ...
                                if(VALUE$((((PARSER$grammer)(CUR$.SL$)).cs==(((PARSER)(CUR$.SL$.SL$)).ISTEP)))) {
                                    {
                                        TRACE_BEGIN_STM$("CompoundStatement1538",1538);
                                        ftype=((char)1);
                                        // JavaLine 138 ==> SourceLine 1539
                                        inspect$1514$6.forvar=inspect$1514$6.curelt;
                                        ...
                                        inspect$1514$6.stepexpr=inspect$1514$6.curelt;
                                        ...
                                        if(VALUE$((((PARSER$grammer)(CUR$.SL$)).cs!=(((PARSER)(CUR$.SL$.SL$)).IUNTI)))) {
                                        ...
                                        {
                                            // BEGIN INSPECTION 
                                            inspect$1551$7=inspect$1514$6.stepexpr.next;
                                            if(inspect$1551$7!=null) //INSPECT inspect$1551$7
                                            // JavaLine 172 ==> SourceLine 1552
                                            {
                                                TRACE_BEGIN_STM$("CompoundStatement1552",1552);
                                                if(VALUE$(((inspect$1514$6.curelt!=(((PARSER$codebuffer$elt)inspect$1551$7)))||(((inspect$1551$7.opnn!=(((PARSER)(CUR$.SL$.SL$)).ISCST))&&((inspect$1551$7.opnn!=(((PARSER)(CUR$.SL$.SL$)).ICONS)))))))) {
                                                    // JavaLine 176 ==> SourceLine 1555
                                                    {
                                                        TRACE_BEGIN_STM$("CompoundStatement1555",1555);
                                                        ftype=((char)4);
                                                        inspect$1514$6.curelt=inspect$1514$6.stepexpr;
                                                        inspect$1514$6.curelt.next=null;
                                            ...
                                            // JavaLine 194 ==> SourceLine 1560
                                            {
                                                ...
                                                if(VALUE$((inspect$1514$6.deltavar==(null)))) {
                                                    // JavaLine 198 ==> SourceLine 1561
                                                    {
                                                        ...
                                                        inspect$1514$6.curelt=inspect$1514$6.firstelt.next;
                                                        ...
                                                        {
                                                            // BEGIN INSPECTION 
                                                            inspect$1570$8=new PARSER$codebuffer$elt(inspect$1514$6).STM$();
                                                            if(inspect$1570$8!=null) //INSPECT inspect$1570$8
                                                            // JavaLine 229 ==> SourceLine 1571
                                                            {
                                                                TRACE_BEGIN_STM$("CompoundStatement1571",1571);
                                                                inspect$1514$6.deltavar=((PARSER$codebuffer$elt)inspect$1570$8);
                                                                // JavaLine 233 ==> SourceLine 1572
                                                                inspect$1570$8.opdhii=((PARSER)(CUR$.SL$.SL$)).hashhi;
                                                                inspect$1570$8.opdloo=((PARSER)(CUR$.SL$.SL$)).hashlo;
                                                                // JavaLine 236 ==> SourceLine 1573
                                                                inspect$1570$8.opnn=((PARSER)(CUR$.SL$.SL$)).IWHIL;
                                                                inspect$1570$8.optxx=((PARSER)(CUR$.SL$.SL$)).IINTG;
                                                                TRACE_END_STM$("CompoundStatement1571",1573);
                                                            }
                                                        }
                                                        // JavaLine 242 ==> SourceLine 1575
                                                        new PARSER$codebuffer$elt$emit(inspect$1514$6.deltavar);
                                                        // JavaLine 244 ==> SourceLine 1576
                                                        inspect$1514$6.deltavar.opnn=((PARSER)(CUR$.SL$.SL$)).IIDN;
                                                ...
                                                inspect$1514$6.curelt=inspect$1514$6.forvar;
                                                ...
                                                new PARSER$codebuffer$copyexpr(inspect$1514$6,inspect$1514$6.stepexpr);
                                                // JavaLine 268 ==> SourceLine 1586
                                                new PARSER$codebuffer$elt$emit(inspect$1514$6.deltavar);
                                                inspect$1514$6.curelt.opnn=((PARSER)(CUR$.SL$.SL$)).ISTEP;
                                                // JavaLine 271 ==> SourceLine 1587
                                                inspect$1514$6.curelt=inspect$1514$6.curelt.next.next;
                                                ...
                                                new PARSER$codebuffer$elt$emit(inspect$1514$6.cvar);
                                        ...
                                        {
                                            // BEGIN INSPECTION 
                                            inspect$1594$9=inspect$1514$6.stepexpr;
                                            if(inspect$1594$9!=null) //INSPECT inspect$1594$9
                                            // JavaLine 291 ==> SourceLine 1595
                                            {
                                                TRACE_BEGIN_STM$("CompoundStatement1595",1595);
                                                new PARSER$codebuffer$elt$emit(inspect$1514$6.cvar);
                                                // JavaLine 295 ==> SourceLine 1597
                                                new PARSER$grammer$forstat$new_elt(((PARSER$grammer$forstat)CUR$),(((loadChar(new COMMON$nameof(((PARSER)(CUR$.SL$.SL$)),inspect$1594$9.opdhii,inspect$1594$9.opdloo).RESULT$,0)==('-')))?(((PARSER)(CUR$.SL$.SL$)).IGE):(((PARSER)(CUR$.SL$.SL$)).ILE)));
                                ...
                                if(VALUE$((((PARSER$grammer)(CUR$.SL$)).cs==(((PARSER)(CUR$.SL$.SL$)).IWHIL)))) {
                                    {
                                        ...
                                        inspect$1514$6.curelt=inspect$1514$6.wheeler;
                                        new PARSER$grammer$forstat$new_elt(((PARSER$grammer$forstat)CUR$),((PARSER)(CUR$.SL$.SL$)).ITRUE);
                                        inspect$1514$6.curelt=inspect$1514$6.forvar;
                                ...
                                if(VALUE$(((((PARSER$grammer)(CUR$.SL$)).cs==(((PARSER)(CUR$.SL$.SL$)).ICOMA))||(commaSeen)))) {
                                    // JavaLine 374 ==> SourceLine 1626
                                    {
                                        ...
                                        if(VALUE$((!(commaSeen)))) {
                                            {
                                                ...
                                                inspect$1514$6.statlabel=inspect$1514$6.curelt;
                                                ...
                                                while((inspect$1514$6.curelt.next.opnn!=(((enclgen)?(((PARSER)(CUR$.SL$.SL$)).IDCLE):(((PARSER)(CUR$.SL$.SL$)).IFOR))))) {
                                                    // JavaLine 402 ==> SourceLine 1637
                                                    inspect$1514$6.curelt=inspect$1514$6.curelt.next;
                                                }
                                                ...
                                                inspect$1514$6.curelt=inspect$1514$6.statlabel;
                                                ...
                                                {
                                                    // BEGIN INSPECTION 
                                                    inspect$1645$10=new PARSER$codebuffer$elt(inspect$1514$6).STM$();
                                                    if(inspect$1645$10!=null) //INSPECT inspect$1645$10
                                                    // JavaLine 429 ==> SourceLine 1646
                                                    {
                                                        TRACE_BEGIN_STM$("CompoundStatement1646",1646);
                                                        inspect$1514$6.statlabel=((PARSER$codebuffer$elt)inspect$1645$10);
                                                        // JavaLine 433 ==> SourceLine 1647
                                                        inspect$1645$10.opdhii=((PARSER)(CUR$.SL$.SL$)).hashhi;
                                                        inspect$1645$10.opdloo=((PARSER)(CUR$.SL$.SL$)).hashlo;
                                                        inspect$1645$10.opnn=((PARSER)(CUR$.SL$.SL$)).IELME;
                                        ...
                                        new PARSER$codebuffer$elt$emit(inspect$1514$6.statlabel);
                                        ...
                                        new PARSER$codebuffer$elt$emit(inspect$1514$6.statlabel);
                                        inspect$1514$6.curelt.opnn=((PARSER)(CUR$.SL$.SL$)).ICL;
                                        TRACE_END_STM$("CompoundStatement1626",1655);
                                    }
                                }
                                // JavaLine 468 ==> SourceLine 1657
                                if(VALUE$((((PARSER$grammer)(CUR$.SL$)).cs==(((PARSER)(CUR$.SL$.SL$)).IDO)))) {
                                    // JavaLine 470 ==> SourceLine 1658
                                    {
                                        TRACE_BEGIN_STM$("CompoundStatement1658",1658);
                                        new PARSER$codebuffer$terminate(inspect$1514$6);
                                ...
                                // JavaLine 482 ==> SourceLine 1664
                                {
                                    ...
                                    LABEL$(5,"PARSE");
                                    inspect$1514$6.firstelt.next=null;
                                ...
                                if(VALUE$(commaSeen)) {
                                    {
                                        ...
                                        inspect$1514$6.statlabel.opnn=((PARSER)(CUR$.SL$.SL$)).IUNTI;
                                        new PARSER$codebuffer$elt$emit(inspect$1514$6.statlabel);
                                ...
                                inspect$1514$6.statlabel=inspect$1514$6.deltavar=inspect$1514$6.forvar=inspect$1514$6.wheeler=inspect$1514$6.cvar=null;
