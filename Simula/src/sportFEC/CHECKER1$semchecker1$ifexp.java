            ...
            public void STM$() {
                ...
                LOOP$:while(JTX$>=0) {
                    try {
                        ...
                        if((p2$testexp.type!=(((CHECKER1)(CUR$.SL$.SL$)).IBOOL))) {
                            {
                                TRACE_BEGIN_STM$("CompoundStatement1125",1125);
                                if((p2$testexp.type!=(((CHECKER1)(CUR$.SL$.SL$)).IELSE))) {
                        ...
                        if((p2$testexp.ctype==(((CHECKER1)(CUR$.SL$.SL$)).IIDN))) {
