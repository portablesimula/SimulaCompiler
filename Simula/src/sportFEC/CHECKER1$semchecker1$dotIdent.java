            ...
            public void STM$() {
                ...
                LOOP$:while(JTX$>=0) {
                    try {
                        ...
                        if((p2$dotexp.type!=(((CHECKER1)(CUR$.SL$.SL$)).IELSE))) {
                            // JavaLine 42 ==> SourceLine 1655
                            {
                                TRACE_BEGIN_STM$("CompoundStatement1655",1655);
                                if((p2$dotexp.ctype==(((CHECKER1)(CUR$.SL$.SL$)).IIDN))) {
                                ...
                                if((p2$dotexp.type==(((CHECKER1)(CUR$.SL$.SL$)).IREF))) {
                                } else
                                // JavaLine 61 ==> SourceLine 1659
                                if((p2$dotexp.type==(((CHECKER1)(CUR$.SL$.SL$)).ITEXT))) {
                                } else
                                // JavaLine 64 ==> SourceLine 1660
                                if((p2$dotexp.type==(((CHECKER1)(CUR$.SL$.SL$)).IPTR))) {
                                } else
                        ...
                        while((meaning!=(null))) {
                            // JavaLine 86 ==> SourceLine 1670
                            {
                                ...
                                if((meaning.symb==(((CHECKER1$semchecker1)(CUR$.SL$)).opdSymb))) {
                                    // JavaLine 90 ==> SourceLine 1671
                                    {
                                        TRACE_BEGIN_STM$("CompoundStatement1671",1671);
                                        if((meaning.visible==(((CHECKER1)(CUR$.SL$.SL$)).NUL))) {
                                            GOTO$(found); // GOTO EVALUATED LABEL
                                        }
                        ...
                        if((((CHECKER1$semchecker1)(CUR$.SL$)).cbrec.declquant.plev!=(((CHECKER1)(CUR$.SL$.SL$)).zero))) {
                        ...
                        if((type==(((CHECKER1)(CUR$.SL$.SL$)).ILABE))) {
                        ...
                        if((kind==(((CHECKER1)(CUR$.SL$.SL$)).K_ident))) {
                            // JavaLine 155 ==> SourceLine 1691
                            {
                                ...
                                if((meaning.categ!=(((CHECKER1)(CUR$.SL$.SL$)).C_name))) {
                                    issimple=1;
                                }
