                    ...
                    try {
                        ...
                        while(true) {
                            // JavaLine 54 ==> SourceLine 2205
                            {
                                ...
                                if(VALUE$(((((PARSER$grammer)(CUR$.SL$)).symboltype.Elt[rank(((PARSER)(CUR$.SL$.SL$)).opt)-((PARSER$grammer)(CUR$.SL$)).symboltype.LB[0]]==(((PARSER$grammer)(CUR$.SL$)).exprtermin))||((startexprstmt&&((((PARSER$grammer)(CUR$.SL$)).symboltype.Elt[rank(((PARSER)(CUR$.SL$.SL$)).opt)-((PARSER$grammer)(CUR$.SL$)).symboltype.LB[0]]==(((PARSER$grammer)(CUR$.SL$)).relop)))))))) {
                                    // JavaLine 60 ==> SourceLine 2211
                                    {
                                        ...
                                        if(VALUE$((((PARSER$grammer)(CUR$.SL$)).cs==(((PARSER)(CUR$.SL$.SL$)).ICONS)))) {
                                ...
                                if(VALUE$((lastsymb==(((PARSER)(CUR$.SL$.SL$)).IRGPA)))) {
                                    NOTrefexpr=true;
                                } else
                                // JavaLine 100 ==> SourceLine 2229
                                if(VALUE$((lastsymb==(((PARSER)(CUR$.SL$.SL$)).IQUA)))) {
