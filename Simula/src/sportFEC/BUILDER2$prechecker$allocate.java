...
public final class BUILDER2$prechecker$allocate extends BASICIO$ {
    ...
    public BUILDER2$prechecker$allocate STM$() {
        ...
        if(VALUE$((brc.kind==(((BUILDER2)(CUR$.SL$.SL$)).K_labbl)))) {
        ...
        // JavaLine 64 ==> SourceLine 1640
        {
            ...
            if(VALUE$((((BUILDER2$prechecker)(CUR$.SL$)).blockpref==(null)))) {
                ...
                // JavaLine 75 ==> SourceLine 1642
                {
                    ...
                    while((TUchain.plev>(((BUILDER2)(CUR$.SL$.SL$)).one))) {
                        // JavaLine 81 ==> SourceLine 1644
                        {
                            ...
                            if(VALUE$(TUchain.descr.thisused)) {
                    ...
                    if(VALUE$((inspect$1641$16.blev!=(brc.blev)))) {
                        // JavaLine 94 ==> SourceLine 1650
                        {
                            TRACE_BEGIN_STM$("CompoundStatement1650",1650);
                            if(VALUE$((IS$(((BUILDER2$prechecker)(CUR$.SL$)).blockpref,COMMON$extquantity.class)&&((((COMMON$extquantity)(((BUILDER2$prechecker)(CUR$.SL$)).blockpref)).clf==(((BUILDER2)(CUR$.SL$.SL$)).Clf004)))))) {
                            } else
                    ...
                    if(VALUE$(inspect$1641$16.localclasses)) {
        ...
        // JavaLine 139 ==> SourceLine 1678
        {
            ...
            if(VALUE$((Q.descr.inspected!=(((BUILDER2)(CUR$.SL$.SL$)).NUL)))) {
