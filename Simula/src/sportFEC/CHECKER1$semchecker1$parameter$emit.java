...
public final class CHECKER1$semchecker1$parameter$emit extends BASICIO$ {
    ...
    CHECKER1$semchecker1$exp inspect$2184$101=null;
    // Normal Constructor
    ...
    public CHECKER1$semchecker1$parameter$emit STM$() {
        ...
        LOOP$:while(JTX$>=0) {
            try {
                ...
                {
                    // BEGIN INSPECTION 
                    inspect$2184$101=((CHECKER1$semchecker1$parameter)(CUR$.SL$)).p$actual;
                    if(inspect$2184$101!=null) //INSPECT inspect$2184$101
                    // JavaLine 36 ==> SourceLine 2185
                    {
                        ...
                        if(((((CHECKER1$semchecker1$parameter)(CUR$.SL$)).p1$formal==(null))||((((CHECKER1$semchecker1$parameter)(CUR$.SL$)).p1$formal.categ==(((CHECKER1)(CUR$.SL$.SL$.SL$)).C_name))))) {
                            // JavaLine 42 ==> SourceLine 2189
                            {
                                    ...
                                    // JavaLine 46 ==> SourceLine 2190
                                    {
                                        ...
                                        if((inspect$2184$101.meaning.protect==(((char)2)))) {
                                            // JavaLine 50 ==> SourceLine 2191
                                            {
                                                ...
                                                if((inspect$2184$101.ctype==(((CHECKER1)(CUR$.SL$.SL$.SL$)).IIDNP))) {
                                ...
                                if(((inspect$2184$101.p$ch==(((CHECKER1)(CUR$.SL$.SL$.SL$)).IIDN))&&((inspect$2184$101.cl!=(((CHECKER1$semchecker1)(CUR$.SL$.SL$)).IEEXPcl))))) {
                                    // JavaLine 69 ==> SourceLine 2206
                                    {
                                        ...
                                        ((CHECKER1$semchecker1)(CUR$.SL$.SL$)).actqty=inspect$2184$101.meaning;
                                        TRACE_END_STM$("CompoundStatement2206",2207);
                                    }
                                } else
                                // JavaLine 78 ==> SourceLine 2209
                                if((inspect$2184$101.p$ch==(((CHECKER1)(CUR$.SL$.SL$.SL$)).ICONS))) {
                                    // JavaLine 80 ==> SourceLine 2210
                                    {
                                        ...
                                        inspect$2184$101.cl=((CHECKER1$semchecker1)(CUR$.SL$.SL$)).IEEXPcl;
                                        // JavaLine 87 ==> SourceLine 2212
                                        switch(inspect$2184$101.type) { // BEGIN SWITCH STATEMENT
                                        case 1: 
                                        case 2: 
                                        case 7: 
                                        // JavaLine 92 ==> SourceLine 2214
                                        {
                                            ...
                                            ((CHECKER1$semchecker1)(CUR$.SL$.SL$)).opt=inspect$2184$101.type;
                                            // JavaLine 97 ==> SourceLine 2215
                                            ((CHECKER1$semchecker1)(CUR$.SL$.SL$)).opilo=((CHECKER1$semchecker1$const$)(((CHECKER1$semchecker1$exp)inspect$2184$101))).ixlo;
                                        ...
                                        // JavaLine 105 ==> SourceLine 2219
                                        {
                                            ...
                                            if((((CHECKER1$semchecker1$const$)(((CHECKER1$semchecker1$exp)inspect$2184$101))).ixhi==(((CHECKER1)(CUR$.SL$.SL$.SL$)).NUL))) {
                                            ...
                                            // JavaLine 117 ==> SourceLine 2223
                                            {
                                                ...
                                                ((CHECKER1$semchecker1)(CUR$.SL$.SL$)).opihi=((CHECKER1$semchecker1$const$)(((CHECKER1$semchecker1$exp)inspect$2184$101))).ixhi;
                            ...
                            inspect$2184$101.cl=(((((inspect$2184$101.ctype==(((CHECKER1)(CUR$.SL$.SL$.SL$)).IIDN))||((inspect$2184$101.ctype==(((CHECKER1)(CUR$.SL$.SL$.SL$)).IIDNP))))&&((inspect$2184$101.cl!=(((CHECKER1$semchecker1)(CUR$.SL$.SL$)).IEEXPcl)))))?(((CHECKER1$semchecker1)(CUR$.SL$.SL$)).IACTEcl):(((CHECKER1$semchecker1)(CUR$.SL$.SL$)).IEEXPcl));
                            // JavaLine 162 ==> SourceLine 2249
                            inspect$2184$101.emit$0().CPF();
                            // JavaLine 164 ==> SourceLine 2250
                            if((((inspect$2184$101.ctype==(((CHECKER1)(CUR$.SL$.SL$.SL$)).IIDN))||((inspect$2184$101.ctype==(((CHECKER1)(CUR$.SL$.SL$.SL$)).IIDNP))))&&((inspect$2184$101.cl==(((CHECKER1$semchecker1)(CUR$.SL$.SL$)).IACTEcl))))) {
                            } else
                            // JavaLine 167 ==> SourceLine 2255
                            {
                                ...
                                if((((CHECKER1$semchecker1)(CUR$.SL$.SL$)).opt==(((CHECKER1)(CUR$.SL$.SL$.SL$)).IREF))) {
                                    ((CHECKER1)(CUR$.SL$.SL$.SL$)).coder.opq=inspect$2184$101.qual;
                                }
                    ...
                    // JavaLine 183 ==> SourceLine 2262
                    {
                        ...
                        if((inspect$2184$101.ctype==(((CHECKER1)(CUR$.SL$.SL$.SL$)).IIDN))) {
                            {
                                ...
                                if((inspect$2184$101.cl!=(((CHECKER1$semchecker1)(CUR$.SL$.SL$)).IACTEcl))) {
                        ...
                        if((((CHECKER1$semchecker1$parameter)(CUR$.SL$)).p1$formal.kind==(((CHECKER1)(CUR$.SL$.SL$.SL$)).K_ident))) {
                            // JavaLine 203 ==> SourceLine 2267
                            {
                                ...
                                if((((CHECKER1$semchecker1$parameter)(CUR$.SL$)).p1$formal.type!=(inspect$2184$101.type))) {
                                    // JavaLine 209 ==> SourceLine 2270
                                    new CHECKER1$semchecker1$MaybeConvert(((CHECKER1$semchecker1)(CUR$.SL$.SL$)),((CHECKER1$semchecker1$parameter)(CUR$.SL$)).p1$formal.type,inspect$2184$101.type);
                                } else
