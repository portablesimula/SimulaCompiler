            ...
            try {
                JUMPTABLE$(JTX$); // For ByteCode Engineering
                {
                    ...
                    // JavaLine 36 ==> SourceLine 2185
                    {
                        ...
                        if(VALUE$(((((CHECKER1$semchecker1$parameter)(CUR$.SL$)).p1$formal==(null))||((((CHECKER1$semchecker1$parameter)(CUR$.SL$)).p1$formal.categ==(((CHECKER1)(CUR$.SL$.SL$.SL$)).C_name)))))) {
                            // JavaLine 42 ==> SourceLine 2189
                            {
                                TRACE_BEGIN_STM$("CompoundStatement2189",2189);
                                if(VALUE$((inspect$2184$17.meaning!=(null)))) {
                                    // JavaLine 46 ==> SourceLine 2190
                                    {
                                        TRACE_BEGIN_STM$("CompoundStatement2190",2190);
                                        if(VALUE$((inspect$2184$17.meaning.protect==(((char)2))))) {
                                            // JavaLine 50 ==> SourceLine 2191
                                            {
                                                TRACE_BEGIN_STM$("CompoundStatement2191",2191);
                                                if(VALUE$((inspect$2184$17.ctype==(((CHECKER1)(CUR$.SL$.SL$.SL$)).IIDN)))) {
                                                ...
                                                if(VALUE$((inspect$2184$17.ctype==(((CHECKER1)(CUR$.SL$.SL$.SL$)).IIDNP)))) {
                                ...
                                if(VALUE$(((inspect$2184$17.p$ch==(((CHECKER1)(CUR$.SL$.SL$.SL$)).IIDN))&&((inspect$2184$17.cl!=(((CHECKER1$semchecker1)(CUR$.SL$.SL$)).IEEXPcl)))))) {
                                ...
                                if(VALUE$((inspect$2184$17.p$ch==(((CHECKER1)(CUR$.SL$.SL$.SL$)).ICONS)))) {
                                    // JavaLine 80 ==> SourceLine 2210
                                    {
                                        ...
                                        // JavaLine 105 ==> SourceLine 2219
                                        {
                                            ...
                                            if(VALUE$((((CHECKER1$semchecker1$const$)(((CHECKER1$semchecker1$exp)inspect$2184$17))).ixhi==(((CHECKER1)(CUR$.SL$.SL$.SL$)).NUL)))) {
                            ...
                            if(VALUE$((((inspect$2184$17.ctype==(((CHECKER1)(CUR$.SL$.SL$.SL$)).IIDN))||((inspect$2184$17.ctype==(((CHECKER1)(CUR$.SL$.SL$.SL$)).IIDNP))))&&((inspect$2184$17.cl==(((CHECKER1$semchecker1)(CUR$.SL$.SL$)).IACTEcl)))))) {
                            } else
                            // JavaLine 167 ==> SourceLine 2255
                            {
                                ...
                                if(VALUE$((((CHECKER1$semchecker1)(CUR$.SL$.SL$)).opt==(((CHECKER1)(CUR$.SL$.SL$.SL$)).IREF)))) {
                    ...
                    // JavaLine 183 ==> SourceLine 2262
                    {
                        ...
                        if(VALUE$((inspect$2184$17.ctype==(((CHECKER1)(CUR$.SL$.SL$.SL$)).IIDN)))) {
                            {
                                ...
                                if(VALUE$((inspect$2184$17.cl!=(((CHECKER1$semchecker1)(CUR$.SL$.SL$)).IACTEcl)))) {
                        ...
                        if(VALUE$((((CHECKER1$semchecker1$parameter)(CUR$.SL$)).p1$formal.kind==(((CHECKER1)(CUR$.SL$.SL$.SL$)).K_ident)))) {
                            // JavaLine 203 ==> SourceLine 2267
                            {
                                ...
                                if(VALUE$((((CHECKER1$semchecker1$parameter)(CUR$.SL$)).p1$formal.type!=(inspect$2184$17.type)))) {
                                ...
                                if(VALUE$(((CHECKER1$semchecker1$parameter)(CUR$.SL$)).implqua)) {
                    ...
                    LABEL$(1,"NxtArg");
                    if(VALUE$((((CHECKER1$semchecker1$parameter)(CUR$.SL$)).nextarg!=(null)))) {
