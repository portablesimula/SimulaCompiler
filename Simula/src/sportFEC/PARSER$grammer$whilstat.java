            ...
            public void STM$() {
                ...
                LOOP$:while(JTX$>=0) {
                    try {
                        ...
                        if(VALUE$(((((((PARSER$grammer)(CUR$.SL$)).cs==(((PARSER)(CUR$.SL$.SL$)).ICONS))&&((((PARSER)(CUR$.SL$.SL$)).opdhi==(((PARSER)(CUR$.SL$.SL$)).NUL))))&&((((PARSER)(CUR$.SL$.SL$)).opdlo==(((PARSER)(CUR$.SL$.SL$)).ITRUE))))&&((((PARSER)(CUR$.SL$.SL$)).opt==(((PARSER)(CUR$.SL$.SL$)).IDO)))))) {
                        ...
                        // JavaLine 52 ==> SourceLine 1164
                        {
                            ...
                            if(VALUE$((((PARSER$grammer)(CUR$.SL$)).ex.wasNotexpr||((((PARSER$grammer)(CUR$.SL$)).cs!=(((PARSER)(CUR$.SL$.SL$)).IDO)))))) {
