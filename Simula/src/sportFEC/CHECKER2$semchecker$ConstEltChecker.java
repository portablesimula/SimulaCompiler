                    ...
                    try {
                        ...
                        while(true) {
                            // JavaLine 44 ==> SourceLine 343
                            {
                                ...
                                if(VALUE$((((CHECKER2$semchecker)(CUR$.SL$)).exptop.p$ch!=(((CHECKER2)(CUR$.SL$.SL$)).ICONS)))) {
                                    {
                                ...
                                if(VALUE$((type!=(etype)))) {
                                    // JavaLine 66 ==> SourceLine 356
                                    {
                                        ...
                                        if(VALUE$(((type==(((CHECKER2)(CUR$.SL$.SL$)).ISHOR))&((etype==(((CHECKER2)(CUR$.SL$.SL$)).IINTG)))))) {
                                        } else
                                ...
                                if(VALUE$((type==(((CHECKER2)(CUR$.SL$.SL$)).ITEXT)))) {
                                    // JavaLine 102 ==> SourceLine 372
                                    {
                                        TRACE_BEGIN_STM$("CompoundStatement372",372);
                                        if(VALUE$((((CHECKER1$semchecker1$const$)(((CHECKER2$semchecker)(CUR$.SL$)).exptop)).ixhi!=(((CHECKER2)(CUR$.SL$.SL$)).NUL)))) {
