        ...
        LOOP$:while(JTX$>=0) {
            try {
                ...
                // JavaLine 58 ==> SourceLine 1198
                {
                    ...
                    if(VALUE$(((PQ.categ==(((BUILDER2)(CUR$.SL$.SL$.SL$.SL$)).C_unknwn))|(((PQ.kind!=(((BUILDER2)(CUR$.SL$.SL$.SL$.SL$)).K_class))&((PQ.kind!=(((BUILDER2)(CUR$.SL$.SL$.SL$.SL$)).K_record)))))))) {
                        // JavaLine 88 ==> SourceLine 1207
                        new ERRMSG$errQTN(((BUILDER2)(CUR$.SL$.SL$.SL$.SL$)),p$subq,409,PQ);
                    } else
                    if(VALUE$((PQ.encl.blev!=(p$subq.encl.blev)))) {
                        // JavaLine 92 ==> SourceLine 1210
                        {
                            TRACE_BEGIN_STM$("CompoundStatement1210",1210);
                            if(VALUE$(IS$(PQ,COMMON$quantity.class))) {
                                GOTO$(PrefErr); // GOTO EVALUATED LABEL
                            }
                            // JavaLine 98 ==> SourceLine 1211
                            if(VALUE$((((COMMON$extquantity)(PQ)).clf==(((BUILDER2)(CUR$.SL$.SL$.SL$.SL$)).Clf009)))) {
                                // JavaLine 100 ==> SourceLine 1214
                                {
                                    ...
                                    if(VALUE$((smlblk.symb!=(null)))) {
                                        // JavaLine 110 ==> SourceLine 1217
                                        {
                                            TRACE_BEGIN_STM$("CompoundStatement1217",1217);
                                            if(VALUE$(TXTREL$EQ(smlblk.symb.symbol,new TXT$("simulation")))) {
                            ...
                            if(VALUE$((((COMMON$extquantity)(PQ)).clf!=(((BUILDER2)(CUR$.SL$.SL$.SL$.SL$)).Clf004)))) {
                    ...
                    if(VALUE$((PQ.match==(((BUILDER2)(CUR$.SL$.SL$.SL$.SL$)).setprefgoing)))) {
