...
public final class CHECKER2$semchecker$unstack$caseSingle extends BASICIO$ {
    ...
    public CHECKER2$semchecker$unstack$caseSingle STM$() {
        ...
        if(VALUE$(IS$(((CHECKER2$semchecker)(CUR$.SL$.SL$)).exptop,CHECKER1$semchecker1$arithconst.class))) {
        ...
        if(VALUE$(IS$(((CHECKER2$semchecker)(CUR$.SL$.SL$)).exptop,CHECKER1$semchecker1$charconst.class))) {
