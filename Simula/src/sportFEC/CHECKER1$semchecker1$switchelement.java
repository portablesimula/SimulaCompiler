    ...
    public CHECKER1$semchecker1$switchelement(RTObject$ staticLink,CHECKER1$semchecker1$exp sp$labelexp) {
        ...
        CODE$=new ClassBody(CODE$,this,0) {
            public void STM$() {
                ...
                if((p$labelexp.type!=(((CHECKER1)(CUR$.SL$.SL$)).ILABE))) {
                    {
                        TRACE_BEGIN_STM$("CompoundStatement2576",2576);
                        if((p$labelexp.type!=(((CHECKER1)(CUR$.SL$.SL$)).IELSE))) {
                ...
                if((p$labelexp.ctype==(((CHECKER1)(CUR$.SL$.SL$)).IIDN))) {
                    // JavaLine 41 ==> SourceLine 2579
                    {
                        ...
                        if((p$labelexp.meaning.categ==(((CHECKER1)(CUR$.SL$.SL$)).C_local))) {
