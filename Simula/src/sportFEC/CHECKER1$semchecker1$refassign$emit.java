...
public final class CHECKER1$semchecker1$refassign$emit extends BASICIO$ {
    ...
    public CHECKER1$semchecker1$refassign$emit STM$() {
        ...
        // JavaLine 56 ==> SourceLine 954
        {
            ...
            if(VALUE$((((CHECKER1$semchecker1$refassign)(CUR$.SL$)).issimple==(0)))) {
        ...
        if(VALUE$(((CHECKER1$semchecker1$refassign)(CUR$.SL$)).implqua)) {
        ...
        if(VALUE$((((CHECKER1$semchecker1$refassign)(CUR$.SL$)).p1$target.ctype==(((CHECKER1)(CUR$.SL$.SL$.SL$)).IIDN)))) {
            // JavaLine 91 ==> SourceLine 971
            {
                TRACE_BEGIN_STM$("CompoundStatement971",971);
                if(VALUE$(((((CHECKER1$semchecker1$refassign)(CUR$.SL$)).issimple!=(0))&&(IS$(((CHECKER1$semchecker1$refassign)(CUR$.SL$)).p1$target,CHECKER1$semchecker1$dotIdent.class))))) {
                ...
                // JavaLine 104 ==> SourceLine 974
                {
                    ...
                    // JavaLine 109 ==> SourceLine 975
                    {
                        ...
                        if(VALUE$((inspect$974$9.categ==(((CHECKER1)(CUR$.SL$.SL$.SL$)).C_virt)))) {
                        ...
                        if(VALUE$((((CHECKER1$semchecker1$refassign)(CUR$.SL$)).issimple!=(0)))) {
                            // JavaLine 119 ==> SourceLine 978
                            {
                                ...
                                if(VALUE$((inspect$974$9.kind==(((CHECKER1)(CUR$.SL$.SL$.SL$)).K_proc)))) {
                        ...
                        if(VALUE$((inspect$974$9.categ==(((CHECKER1)(CUR$.SL$.SL$.SL$)).C_name)))) {
        ...
        if(VALUE$((((CHECKER1$semchecker1$refassign)(CUR$.SL$)).cl==(((CHECKER1$semchecker1)(CUR$.SL$.SL$)).IEEXPcl)))) {
