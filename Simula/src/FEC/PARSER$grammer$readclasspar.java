    ...
    public PARSER$grammer$readclasspar STM$() {
        ...
        LOOP$:while(JTX$>=0) {
            try {
                ...
                if((((PARSER$grammer)(CUR$.SL$)).cs==(((PARSER)(CUR$.SL$.SL$)).IVIRT))) {
                ...
                if((((((PARSER$grammer)(CUR$.SL$)).cs==(((PARSER)(CUR$.SL$.SL$)).IHIDD))||((((PARSER$grammer)(CUR$.SL$)).cs==(((PARSER)(CUR$.SL$.SL$)).ITO))))||((((PARSER$grammer)(CUR$.SL$)).cs==(((PARSER)(CUR$.SL$.SL$)).IPRTC))))) {
                ...
                if((((PARSER$grammer)(CUR$.SL$)).symboltype.Elt[rank(((PARSER$grammer)(CUR$.SL$)).cs)-((PARSER$grammer)(CUR$.SL$)).symboltype.LB[0]]==(((PARSER$grammer)(CUR$.SL$)).declsymbol))) {
