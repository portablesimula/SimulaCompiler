...
package FEC;
// Release-Beta-0.3 Compiled at Fri Jan 04 14:58:56 CET 2019
...
public final class SCANINP$Pass1 extends BASICIO$ {
    ...
    public SCANINP$Pass1 STM$() {
        ...
        if((((SCANINP)(CUR$.SL$)).maxnumoftags>(0))) {
        ...
        if((((SCANINP)(CUR$.SL$)).option.Elt[rank('O')-((SCANINP)(CUR$.SL$)).option.LB[0]]!=(((SCANINP)(CUR$.SL$)).NUL))) {
        ...
        if(TRF_EQ(((SCANINP)(CUR$.SL$)).nscodename,null)) {
