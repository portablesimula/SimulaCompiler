 ...
 *
 */
public final class RunCmdTestBatch {
...
//			String name=names.get(130);
	...
	private static int callSimulaCompiler(final String fileName) {
		Vector<String> cmds=new Vector<String>();
		cmds.add("java");
		cmds.add("-jar");
		cmds.add("C:\\Users\\Øystein\\Simula\\Simula-2.0\\simula.jar");
//		cmds.add("-verbose");
		cmds.add("-nowarn");
