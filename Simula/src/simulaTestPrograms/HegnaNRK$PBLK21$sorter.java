...
public final class HegnaNRK$PBLK21$sorter extends BASICIO$ {
    ...
    final LABQNT$ overogut=new LABQNT$(this,1,"overogut"); // Local Label #1=overogut
    // JavaLine 16 <== SourceLine 1425
    final LABQNT$ igjen=new LABQNT$(this,2,"igjen"); // Local Label #2=igjen
...
CUR$=THIS$;
if(q.SL$!=CUR$) {
    if(RT.Option.GOTO_TRACING) TRACE_GOTO("sorter:NON-LOCAL",q);
    CUR$.STATE$=OperationalState.terminated;
    if(RT.Option.GOTO_TRACING) TRACE_GOTO("sorter:RE-THROW",q);
    throw(q);
}
if(RT.Option.GOTO_TRACING) TRACE_GOTO("sorter:LOCAL",q);
...
public static PROGINFO$ INFO$=new PROGINFO$("HegnaNRK.sim","Procedure sorter",1,1396,14,1415,16,1425,19,1402,21,1403,30,1404,60,1402,74,1405,76,1406,86,1408,90,1409,95,1411,99,1412,104,1413,106,1415,109,1416,113,1418,117,1419,119,1420,123,1422,127,1423,129,1424,131,1426,133,1425,137,1426,139,1427,141,1429,145,1430,147,1431,149,1432,156,1434,158,1435,183,1438);
} // End of Procedure
