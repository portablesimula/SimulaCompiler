...
public class HegnaNRK$PBLK21$tekstverdi extends HegnaNRK$PBLK21$verdi {
    ...
    public HegnaNRK$PBLK21$tekstverdi STM$() {
        TRACE_BEGIN_STM$("tekstverdi",210);
        // Class verdi: Code before inner
        // JavaLine 29 <== SourceLine 213
        // Class tekstverdi: Code before inner
        // Class tekstverdi: Code after inner
        // Class verdi: Code after inner
        TRACE_END_STM$("tekstverdi",213);
        EBLK();
        return(this);
    } // End of Class Statements
    public static PROGINFO$ INFO$=new PROGINFO$("HegnaNRK.sim","Class tekstverdi",1,106,11,107,29,213,36,213);
} // End of Class
