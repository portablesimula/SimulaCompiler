...
public class QueDemo$$QueueingSystem$Generator extends Process$ {
    ...
    public int si$3=0;
    // Normal Constructor
    public QueDemo$$QueueingSystem$Generator(RTObject$ staticLink) {
        super(staticLink);
    ...
    // Class Statements
    public QueDemo$$QueueingSystem$Generator STM$() {
        ...
        while(true) {
            // JavaLine 32 <== SourceLine 13
            {
                ...
                nrph$3=Poisson(((double)(3.9f)),((QueDemo$)(CUR$.SL$.SL$)).U1);
                // JavaLine 36 <== SourceLine 15
                ((QueDemo$$QueueingSystem)(CUR$.SL$)).hold(((double)(1.0f)));
                // JavaLine 38 <== SourceLine 16
                if(VALUE$((((QueDemo$$QueueingSystem)(CUR$.SL$)).time()<(((double)(22.0f)))))) {
                    // JavaLine 40 <== SourceLine 17
                    {
                        TRACE_BEGIN_STM$("CompoundStatement17",17);
                        ((QueDemo$$QueueingSystem)(CUR$.SL$)).acm.Elt[((int)((int)Math.round(((QueDemo$$QueueingSystem)(CUR$.SL$)).time())))-((QueDemo$$QueueingSystem)(CUR$.SL$)).acm.LB[0]]=Math.addExact(((QueDemo$$QueueingSystem)(CUR$.SL$)).acm.Elt[((int)((int)Math.round(((QueDemo$$QueueingSystem)(CUR$.SL$)).time())))-((QueDemo$$QueueingSystem)(CUR$.SL$)).acm.LB[0]],nrph$3);
                        ((QueDemo$$QueueingSystem)(CUR$.SL$)).totnr$2=Math.addExact(((QueDemo$$QueueingSystem)(CUR$.SL$)).totnr$2,nrph$3);
                        ...
                        ((QueDemo$$QueueingSystem)(CUR$.SL$)).ActivateDelay(false,((QueDemo$$QueueingSystem$Truck)new QueDemo$$QueueingSystem$Truck(((QueDemo$$QueueingSystem)(CUR$.SL$))).START$()),1.0f-((((float)(si$3))/(((float)(nrph$3))))),false);
                    }
...
public static PROGINFO$ INFO$=new PROGINFO$("QueDemo.sim","Class Generator",1,11,27,1,29,12,32,13,36,15,38,16,40,17,45,18,49,19,59,12,62,1,64,12,68,21);
} // End of Class
