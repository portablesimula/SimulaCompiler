...
public final class HegnaNRK$PBLK21$skriv_utbase$SubBlock1262 extends BASICIO$ {
    ...
    public RTObject$ STM$() {
        ...
        ((HegnaNRK$PBLK21$skriv_utbase)(CUR$.SL$)).inspect$1261$10.outint(((HegnaNRK$PBLK21)(CUR$.SL$.SL$)).antall_felt_def,3);
    ...
    ((HegnaNRK$PBLK21$skriv_utbase)(CUR$.SL$)).inspect$1261$10.outint(((HegnaNRK$PBLK21)(CUR$.SL$.SL$)).antall_format_def,3);
    ...
    // JavaLine 56 ==> SourceLine 1279
    {
        ...
        // JavaLine 67 ==> SourceLine 1283
        {
            ...
            if(((HegnaNRK$PBLK21$skriv_utbase)(CUR$.SL$)).inspect$1283$11!=null) //INSPECT inspect$1283$11
...
((HegnaNRK$PBLK21$skriv_utbase)(CUR$.SL$)).inspect$1261$10.outint(((HegnaNRK$PBLK21)(CUR$.SL$.SL$)).antall_poster,5);
...
// JavaLine 111 ==> SourceLine 1299
{
    ...
    if(((HegnaNRK$PBLK21$skriv_utbase)(CUR$.SL$)).inspect$1299$12!=null) //INSPECT inspect$1299$12
    // JavaLine 116 ==> SourceLine 1301
    {
        ...
        // JavaLine 130 ==> SourceLine 1307
        {
            ...
            if(VALUE$((k==(1)))) {
                ...
                ((HegnaNRK$PBLK21$skriv_utbase)(CUR$.SL$)).inspect$1261$10.outint(((HegnaNRK$PBLK21$heltallverdi)(((HegnaNRK$PBLK21$skriv_utbase)(CUR$.SL$)).inspect$1299$12.felt.Elt[j-((HegnaNRK$PBLK21$skriv_utbase)(CUR$.SL$)).inspect$1299$12.felt.LB[0]])).tall,8);
            } else
