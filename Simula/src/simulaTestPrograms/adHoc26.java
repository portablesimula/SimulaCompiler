...
// Simula-Beta-0.3 Compiled at Wed Feb 06 20:31:26 CET 2019
...
public final class adHoc26 extends BASICIO$ {
    ...
    final LABQNT$ T0=new LABQNT$(this,0,1); // Local Label #1=T0
    // JavaLine 12 ==> SourceLine 17
    final LABQNT$ T1=new LABQNT$(this,0,2); // Local Label #2=T1
    // JavaLine 14 ==> SourceLine 20
    final LABQNT$ T2=new LABQNT$(this,0,3); // Local Label #3=T2
    // JavaLine 16 ==> SourceLine 22
    final LABQNT$ L1=new LABQNT$(this,0,4); // Local Label #4=L1
    // JavaLine 18 ==> SourceLine 23
    final LABQNT$ L2=new LABQNT$(this,0,5); // Local Label #5=L2
    // JavaLine 20 ==> SourceLine 28
    final LABQNT$ L3=new LABQNT$(this,0,6); // Local Label #6=L3
    ...
    public static PROGINFO$ INFO$=new PROGINFO$("adHoc26.sim","SimulaProgram adHoc26",1,2,10,12,12,17,14,20,16,22,18,23,20,28,23,2,26,3,43,8,45,12,48,24,52,22,54,23,62,28,86,28);
}
