...
public final class Docking$PBLK12$Warehouse$drawMap extends BASICIO$ {
    ...
    public Docking$PBLK12$Warehouse$drawMap STM$() {
        ...
        ((Docking$PBLK12)(CUR$.SL$.SL$)).setFillColor(((Docking$PBLK12)(CUR$.SL$.SL$)).cyan);
        // JavaLine 46 ==> SourceLine 64
        new Docking$PBLK12$Warehouse$FillSquare(((Docking$PBLK12$Warehouse)(CUR$.SL$)),((double)(2)),((double)(22)),((double)(21)),((double)(4)));
        // JavaLine 48 ==> SourceLine 65
        new Docking$PBLK12$Warehouse$FillSquare(((Docking$PBLK12$Warehouse)(CUR$.SL$)),((double)(2)),((double)(26)),((double)(4)),((double)(100)));
        // JavaLine 50 ==> SourceLine 66
        new Docking$PBLK12$Warehouse$FillSquare(((Docking$PBLK12$Warehouse)(CUR$.SL$)),((double)(19)),((double)(26)),((double)(4)),((double)(100)));
        ...
        // JavaLine 56 ==> SourceLine 68
        {
            ...
            dLine=(((Docking$PBLK12$Warehouse)(CUR$.SL$)).dLine1+(((psl-(1))*(20))));
            // JavaLine 60 ==> SourceLine 69
            new Docking$PBLK12$Warehouse$FillSquare(((Docking$PBLK12$Warehouse)(CUR$.SL$)),((double)((dLine-(8)))),((double)(32)),((double)(21)),((double)(4)));
            // JavaLine 62 ==> SourceLine 70
            new Docking$PBLK12$Warehouse$FillSquare(((Docking$PBLK12$Warehouse)(CUR$.SL$)),((double)((dLine-(8)))),((double)(36)),((double)(4)),((double)(240)));
            // JavaLine 64 ==> SourceLine 71
            new Docking$PBLK12$Warehouse$FillSquare(((Docking$PBLK12$Warehouse)(CUR$.SL$)),((double)(((dLine+(4))+(((Docking$PBLK12$Warehouse)(CUR$.SL$)).vanWidth)))),((double)(36)),((double)(4)),((double)(240)));
            TRACE_END_STM$("CompoundStatement68",71);
        }
    }
    // JavaLine 69 ==> SourceLine 73
    ((Docking$PBLK12)(CUR$.SL$.SL$)).setDrawColor(((Docking$PBLK12)(CUR$.SL$.SL$)).orange);
    // JavaLine 71 ==> SourceLine 74
    ((Docking$PBLK12)(CUR$.SL$.SL$)).setFontStyleBoldItalic();
    // JavaLine 73 ==> SourceLine 75
    if(VALUE$(((Docking$PBLK12)(CUR$.SL$.SL$)).DEBUG)) {
        // JavaLine 75 ==> SourceLine 76
        {
            TRACE_BEGIN_STM$("CompoundStatement76",76);
            sysout().outtext(new TXT$("dLine1="));
            sysout().outint(((Docking$PBLK12$Warehouse)(CUR$.SL$)).dLine1,0);
            sysout().outimage();
            // JavaLine 81 ==> SourceLine 77
            sysout().outtext(new TXT$("pPos="));
            sysout().outint(((Docking$PBLK12$Warehouse)(CUR$.SL$)).pPos,0);
            sysout().outimage();
            // JavaLine 85 ==> SourceLine 78
            sysout().outtext(new TXT$("uPos="));
            sysout().outint(((Docking$PBLK12$Warehouse)(CUR$.SL$)).uPos,0);
            sysout().outimage();
            // JavaLine 89 ==> SourceLine 79
            sysout().outtext(new TXT$("wPos="));
            sysout().outint(((Docking$PBLK12$Warehouse)(CUR$.SL$)).wPos,0);
            sysout().outimage();
            TRACE_END_STM$("CompoundStatement76",79);
        }
    }
    // JavaLine 96 ==> SourceLine 81
    new Docking$PBLK12$Warehouse$drawText(((Docking$PBLK12$Warehouse)(CUR$.SL$)),new TXT$("Platform:"),((double)(((Docking$PBLK12$Warehouse)(CUR$.SL$)).pPos)),((double)(60)));
    // JavaLine 98 ==> SourceLine 82
    new Docking$PBLK12$Warehouse$drawText(((Docking$PBLK12$Warehouse)(CUR$.SL$)),new TXT$("Unload:"),((double)(((Docking$PBLK12$Warehouse)(CUR$.SL$)).uPos)),((double)(60)));
    // JavaLine 100 ==> SourceLine 83
    new Docking$PBLK12$Warehouse$drawText(((Docking$PBLK12$Warehouse)(CUR$.SL$)),new TXT$("Wash:"),((double)(((Docking$PBLK12$Warehouse)(CUR$.SL$)).wPos)),((double)(60)));
