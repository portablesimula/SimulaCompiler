        ...
        while((elt!=(null))) {
            // JavaLine 32 ==> SourceLine 44
            {
                ...
                // JavaLine 36 ==> SourceLine 45
                {
                    // BEGIN INSPECTION 
                    inspect$45$0=elt;
                    //INSPECT inspect$45$0
                    if(inspect$45$0 instanceof ShapeElement$) // WHEN ShapeElement$ DO 
                    // JavaLine 42 ==> SourceLine 46
                    {
                        TRACE_BEGIN_STM$("CompoundStatement46",46);
                        ((ShapeElement$)inspect$45$0).instantMoveTo(((double)(5000)),((double)(5000)));
                        // JavaLine 46 ==> SourceLine 48
                        ((ShapeElement$)inspect$45$0).out();
