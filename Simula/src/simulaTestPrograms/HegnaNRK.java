...
public final class HegnaNRK extends Simset$ {
    ...
    public HegnaNRK(RTObject$ staticLink) {
        ...
        format_peker=new ARRAY$<HegnaNRK$format[]>(new HegnaNRK$format[format_peker$UB[0]-format_peker$LB[0]+1],format_peker$LB,format_peker$UB);
        ...
        intern_felt=new ARRAY$<HegnaNRK$verdi[]>(new HegnaNRK$verdi[intern_felt$UB[0]-intern_felt$LB[0]+1],intern_felt$LB,intern_felt$UB);
        ...
        siste_felt_verdi_lest=new ARRAY$<HegnaNRK$verdi[]>(new HegnaNRK$verdi[siste_felt_verdi_lest$UB[0]-siste_felt_verdi_lest$LB[0]+1],siste_felt_verdi_lest$LB,siste_felt_verdi_lest$UB);
        ...
        finnefeltpeker=new ARRAY$<HegnaNRK$verdi[]>(new HegnaNRK$verdi[finnefeltpeker$UB[0]-finnefeltpeker$LB[0]+1],finnefeltpeker$LB,finnefeltpeker$UB);
        ...
        post_peker=new ARRAY$<HegnaNRK$post[]>(new HegnaNRK$post[post_peker$UB[0]-post_peker$LB[0]+1],post_peker$LB,post_peker$UB);
    ...
    public HegnaNRK STM$() {
        ...
        new HegnaNRK$main(((HegnaNRK)CUR$));
        EBLK();
        return(this);
    }
