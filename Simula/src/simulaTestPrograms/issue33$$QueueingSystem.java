...
public class issue33$$QueueingSystem extends Simulation$ {
    ...
    // Normal Constructor
    public issue33$$QueueingSystem(RTObject$ staticLink,int sp2$nDocks,int sp2$nForks) {
        super(staticLink);
    ...
    // Class Statements
    public issue33$$QueueingSystem STM$() {
...
public static PROGINFO$ INFO$=new PROGINFO$("issue33.sim","Class QueueingSystem",13,8,17,9,19,35,30,9,41,44,45,45,51,47,54,44,59,48);
} // End of Class
