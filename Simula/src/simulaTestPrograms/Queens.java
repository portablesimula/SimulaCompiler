...
// Simula-Beta-0.3 Compiled at Tue Jan 22 17:04:42 CET 2019
...
public final class Queens extends BASICIO$ {
    ...
    public Queens(RTObject$ staticLink) {
        ...
        BPRG("Queens");
        // Declaration Code
        TRACE_BEGIN_DCL$("Queens",6);
    } // End of Constructor
    // SimulaProgram Statements
    public RTObject$ STM$() {
        TRACE_BEGIN_STM$("Queens",6);
...
public static PROGINFO$ INFO$=new PROGINFO$("Queens.sim","SimulaProgram Queens",1,6,23,7,27,18,39,19);
}
