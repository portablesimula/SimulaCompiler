...
public final class Queens$SubBlock8 extends BASICIO$ {
                ...
                while((sysout().pos()!=(((Queens)(CUR$.SL$)).i))) {
                    {
                        ...
                        if(VALUE$(((j==(k))|(((((double)(3))*(abs(((double)((j-(k)))))))==(abs(((double)((((Queens)(CUR$.SL$)).i-(sysout().pos()))))))))))) {
                            GOTO$(e);
                        }
    ...
    public static PROGINFO$ INFO$=new PROGINFO$("Queens.sim","SubBlock SubBlock8",1,8,8,9,10,8,22,10,24,9,26,10,32,11,35,12,37,13,40,14,44,15,48,17,63,18);
}
