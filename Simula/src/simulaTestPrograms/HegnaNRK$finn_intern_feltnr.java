...
public final class HegnaNRK$finn_intern_feltnr extends BASICIO$ {
    ...
    public HegnaNRK$finn_intern_feltnr setPar(Object param) {
        try {
            switch($npar++) {
    ...
    public HegnaNRK$finn_intern_feltnr(RTObject$ SL$)
    { super(SL$); }
    public HegnaNRK$finn_intern_feltnr(RTObject$ SL$,int sp$feltnr) {
        super(SL$);
        this.p$feltnr = sp$feltnr;
        BBLK();
        STM$();
    }
    public HegnaNRK$finn_intern_feltnr STM$() {
        HegnaNRK$finn_intern_feltnr THIS$=(HegnaNRK$finn_intern_feltnr)CUR$;
        LOOP$:while(JTX$>=0) {
            try {
                JUMPTABLE$(JTX$);
                nr=0;
                ...
                if(VALUE$((((HegnaNRK)(CUR$.SL$)).intern_feltnr.Elt[i-((HegnaNRK)(CUR$.SL$)).intern_feltnr.LB[0]]==(p$feltnr)))) {
                    {
                        nr=i;
                        GOTO$(out);
                    }
