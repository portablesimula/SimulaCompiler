...
// Simula-Beta-0.3 Compiled at Sun May 05 11:00:19 CEST 2019
...
public final class DatesTest$PBLK4 extends Dates {
    ...
    public DatesTest$PBLK4(RTObject$ staticLink) {
        super(staticLink);
        BPRG("DatesTest$PBLK4");
    }
    public DatesTest$PBLK4 STM$() {
        ...
        TD$1=new Dates$Today(((DatesTest$PBLK4)CUR$)).RESULT$;
        sysout().outtext(CONC(CONC(new TXT$("I dag er det "),new Dates$Date$Image(TD$1).RESULT$),new TXT$(".")));
        sysout().outimage();
        P$1=new Dates$Easter(((DatesTest$PBLK4)CUR$),TD$1.p$Y).RESULT$;
        ...
        sysout().outimage();
        M1$1=new Dates$Date(((DatesTest$PBLK4)CUR$),1,5,TD$1.p$Y).STM$();
        M17$1=new Dates$Date(((DatesTest$PBLK4)CUR$),17,5,TD$1.p$Y).STM$();
    ...
    public static void main(String[] args) {
        ...
        new DatesTest$PBLK4(CTX$).STM$();
    }
    public static PROGINFO$ INFO$=new PROGINFO$("DatesTest.sim","PrefixedBlock DatesTest$PBLK4",1,4,19,265,21,266,23,267,25,268,27,270,30,271,33,272,36,273,39,274,42,275,45,276,48,6,50,7,53,9,55,10,58,12,60,13,62,14,64,16,67,17,69,18,73,19,76,21,78,22,82,23,92,26);
}
