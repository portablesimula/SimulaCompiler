...
public final class 8Queens$SubBlock8 extends BASICIO$ {
    ...
    int j=0;
    // Normal Constructor
    public 8Queens$SubBlock8(RTObject$ staticLink) {
        super(staticLink);
        BBLK();
        // Declaration Code
    ...
    public RTObject$ STM$() {
        ...
        8Queens$SubBlock8 THIS$=(8Queens$SubBlock8)CUR$;
        LOOP$:while(JTX$>=0) {
            try {
                ...
                while((j==(8))) {
                    // JavaLine 34 ==> SourceLine 10
                    {
                        ...
                        ((8Queens)(CUR$.SL$)).i=(((8Queens)(CUR$.SL$)).i-(3));
                        j=TXT$.getint(TXT$.sub(sysout().image,((8Queens)(CUR$.SL$)).i,1));
                ...
                while((sysout().pos()!=(((8Queens)(CUR$.SL$)).i))) {
                    // JavaLine 47 ==> SourceLine 13
                    {
                        ...
                        if(((j==(k))|(((((double)(3))*(abs(((double)((j-(k)))))))==(abs(((double)((((8Queens)(CUR$.SL$)).i-(sysout().pos())))))))))) {
