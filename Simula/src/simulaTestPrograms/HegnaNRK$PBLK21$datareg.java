...
public final class HegnaNRK$PBLK21$datareg extends BASICIO$ {
    ...
    public HegnaNRK$PBLK21$datareg STM$() {
        ...
        {
            // BEGIN INSPECTION 
            inspect$1045$5=((HegnaNRK$PBLK21)(CUR$.SL$)).format_peker.Elt[((HegnaNRK$PBLK21)(CUR$.SL$)).formatnr-((HegnaNRK$PBLK21)(CUR$.SL$)).format_peker.LB[0]];
            if(inspect$1045$5!=null) //INSPECT inspect$1045$5
                ...
                while(mer) {
                    // JavaLine 44 ==> SourceLine 1050
                    {
                        ...
                        // JavaLine 52 ==> SourceLine 1053
                        {
                            ...
                            ((HegnaNRK$PBLK21)(CUR$.SL$)).feltnr=inspect$1045$5.fnr.Elt[i-inspect$1045$5.fnr.LB[0]];
