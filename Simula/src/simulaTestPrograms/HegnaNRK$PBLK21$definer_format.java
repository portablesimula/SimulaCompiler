...
public final class HegnaNRK$PBLK21$definer_format extends BASICIO$ {
    ...
    public HegnaNRK$PBLK21$definer_format STM$() {
        ...
        // JavaLine 32 ==> SourceLine 906
        {
            ...
            {
                // BEGIN INSPECTION 
                inspect$925$4=((HegnaNRK$PBLK21)(CUR$.SL$)).format_peker.Elt[((HegnaNRK$PBLK21)(CUR$.SL$)).antall_format_def-((HegnaNRK$PBLK21)(CUR$.SL$)).format_peker.LB[0]];
                if(inspect$925$4!=null) //INSPECT inspect$925$4
                // JavaLine 77 ==> SourceLine 927
                {
                    TRACE_BEGIN_STM$("CompoundStatement927",927);
                    inspect$925$4.ark_lengde=((HegnaNRK$PBLK21)(CUR$.SL$)).format_ark_lengde;
