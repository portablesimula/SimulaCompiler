...
// Simula-Beta-0.3 Compiled at Wed May 08 17:49:19 CEST 2019
import simula.runtime.*;
@SuppressWarnings("unchecked")
public final class AnimationTest extends Drawing$ {
    ...
    public AnimationTest STM$() {
        ...
        txt1$2=new TextElement$(((AnimationTest)CUR$),new TXT$("Abracadabra"),((double)(200)),((double)(100))).STM$();
        while((elt1$2!=(null))) {
            {
    ...
    public static void main(String[] args) {
        ...
        new AnimationTest(CTX$,new TXT$("Animation Test"),900,900).STM$();
    }
    public static PROGINFO$ INFO$=new PROGINFO$("AnimationTest.sim","PrefixedBlock AnimationTest",1,3,12,4,14,5,22,7,24,8,26,9,28,10,30,12,32,13,34,15,36,16,38,17,40,19,42,20,44,21,46,22,48,23,50,24,52,25,54,27,56,29,59,30,61,31,63,32,65,33,67,34,69,35,71,36,73,37,75,38,77,39,79,40,81,41,83,42,85,43,96,46);
}
