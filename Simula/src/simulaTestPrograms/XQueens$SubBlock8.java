...
public final class XQueens$SubBlock8 extends BASICIO$ {
    ...
    int j=0;
    // Normal Constructor
    public XQueens$SubBlock8(RTObject$ staticLink) {
        super(staticLink);
        BBLK();
        // Declaration Code
    ...
    public RTObject$ STM$() {
        ...
        XQueens$SubBlock8 THIS$=(XQueens$SubBlock8)CUR$;
        LOOP$:while(JTX$>=0) {
            try {
                ...
                while((j==(8))) {
                    // JavaLine 34 ==> SourceLine 10
                    {
                        ...
                        ((XQueens)(CUR$.SL$)).i=(((XQueens)(CUR$.SL$)).i-(3));
                        j=TXT$.getint(TXT$.sub(sysout().image,((XQueens)(CUR$.SL$)).i,1));
                ...
                while((sysout().pos()!=(((XQueens)(CUR$.SL$)).i))) {
                    // JavaLine 47 ==> SourceLine 13
                    {
                        ...
                        if(VALUE$(((j==(k))|(((((double)(3))*(abs(((double)((j-(k)))))))==(abs(((double)((((XQueens)(CUR$.SL$)).i-(sysout().pos()))))))))))) {
    ...
    public static PROGINFO$ INFO$=new PROGINFO$("8Queens.sim","SubBlock SubBlock8",1,8,10,9,13,8,30,10,32,9,34,10,42,11,45,12,47,13,51,14,55,15,60,17,78,18);
}
