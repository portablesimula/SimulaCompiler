...
public final class HegnaNRK$lede_tekst extends BASICIO$ {
    public int prefixLevel() { return(0); }
    public TXT$ p$tekst;
    private int $npar=0; // Number of actual parameters transmitted.
    public HegnaNRK$lede_tekst setPar(Object param) {
        try {
            switch($npar++) {
    ...
    public HegnaNRK$lede_tekst(RTObject$ SL$)
    { super(SL$); }
    public HegnaNRK$lede_tekst(RTObject$ SL$,TXT$ sp$tekst) {
        super(SL$);
        this.p$tekst = sp$tekst;
        BBLK();
        STM$();
    }
    public HegnaNRK$lede_tekst STM$() {
