...
public final class simtst123$trace extends BASICIO$ {
    ...
    public simtst123$trace STM$() {
        ...
        ((simtst123)(CUR$.SL$)).traceCase=(((simtst123)(CUR$.SL$)).traceCase+(1));
        EBLK();
        return(this);
    }
    public static PROGINFO$ INFO$=new PROGINFO$("simtst123.sim","Procedure trace",1,20,29,22,36,23,38,25,41,26,45,27,48,28,53,30,57,31);
}
