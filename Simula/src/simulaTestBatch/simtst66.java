...
public final class simtst66 extends BASICIO$ {
    ...
    public RTObject$ STM$() {
        ...
        if((!(new simtst66$Ok(((simtst66)CUR$),fil1,fil2,1).RESULT$))) {
    ...
    public static PROGINFO$ INFO$=new PROGINFO$("simtst66.sim","SimulaProgram simtst66",1,10,12,11,14,13,16,68,30,79,32,80,36,81,38,82,40,83,42,84,44,85,50,90,52,91,54,92,56,94,58,96,60,115,63,117,65,119,68,120,74,123,77,126,79,127,83,131,96,131);
}
